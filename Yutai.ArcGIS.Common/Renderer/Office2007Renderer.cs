...
namespace Yutai.ArcGIS.Common.Renderer
{
    public class Office2007Renderer : ToolStripProfessionalRenderer
    {
        ...
        private static Class6 _itemContextItemEnabledColors;
        private static Class6 _itemDisabledColors;
        private static Class6 _itemToolItemCheckedColors;
        private static Class6 _itemToolItemCheckPressColors;
        private static Class6 _itemToolItemPressedColors;
        private static Class6 _itemToolItemSelectedColors;
        ...
        private void method_11(Graphics graphics_0, bool bool_0, Rectangle rectangle_0, Pen pen_0, Pen pen_1, int int_0,
            bool bool_1)
        {
            int num;
            if (bool_0)
        ...
        private GraphicsPath method_13(Rectangle rectangle_0, float float_0)
        {
            ...
            path.AddLine(rectangle_0.Left + float_0, (float) rectangle_0.Top, rectangle_0.Right - float_0,
                (float) rectangle_0.Top);
            path.AddLine(rectangle_0.Right - float_0, (float) rectangle_0.Top, (float) rectangle_0.Right,
                rectangle_0.Top + float_0);
            path.AddLine((float) rectangle_0.Right, rectangle_0.Top + float_0, (float) rectangle_0.Right,
                rectangle_0.Bottom - float_0);
            path.AddLine((float) rectangle_0.Right, rectangle_0.Bottom - float_0, rectangle_0.Right - float_0,
                (float) rectangle_0.Bottom);
            path.AddLine(rectangle_0.Right - float_0, (float) rectangle_0.Bottom, rectangle_0.Left + float_0,
                (float) rectangle_0.Bottom);
            path.AddLine(rectangle_0.Left + float_0, (float) rectangle_0.Bottom, (float) rectangle_0.Left,
                rectangle_0.Bottom - float_0);
            path.AddLine((float) rectangle_0.Left, rectangle_0.Bottom - float_0, (float) rectangle_0.Left,
                rectangle_0.Top + float_0);
            path.AddLine((float) rectangle_0.Left, rectangle_0.Top + float_0, rectangle_0.Left + float_0,
                (float) rectangle_0.Top);
            return path;
        }
        ...
        private GraphicsPath method_18(ToolStripItem toolStripItem_0, Rectangle rectangle_0,
            ArrowDirection arrowDirection_0)
        {
            int num;
            int num2;
        ...
        private void method_2(Graphics graphics_0, ToolStripSplitButton toolStripSplitButton_0, ToolStrip toolStrip_0)
        {
            if (toolStripSplitButton_0.Selected || toolStripSplitButton_0.Pressed)
            {
                if (toolStripSplitButton_0.Enabled)
                {
                    ...
                    {
                        this.method_4(graphics_0, toolStripSplitButton_0, _itemToolItemPressedColors,
                    ...
                    {
                        this.method_4(graphics_0, toolStripSplitButton_0, _itemToolItemSelectedColors,
                            _itemToolItemSelectedColors, _itemContextItemEnabledColors);
                    }
                }
                else
        ...
        private void method_3(Graphics graphics_0, ToolStripItem toolStripItem_0, Class6 class6_0)
        {
            this.method_7(graphics_0, new Rectangle(Point.Empty, toolStripItem_0.Bounds.Size), class6_0);
        }

        private void method_4(Graphics graphics_0, ToolStripSplitButton toolStripSplitButton_0, Class6 class6_0,
            Class6 class6_1, Class6 class6_2)
        {
            ...
            if ((((rectangle.Width > 0) && (dropDownButtonBounds.Width > 0)) && (rectangle.Height > 0)) &&
                (dropDownButtonBounds.Height > 0))
            {
                ...
                {
                    this.method_8(graphics_0, rectangle4, class6_0);
                    this.method_8(graphics_0, dropDownButtonBounds, class6_1);
                    using (
                        LinearGradientBrush brush =
                            new LinearGradientBrush(
                                new Rectangle(rectangle.X + x, rectangle.Top, 1, rectangle.Height + 1), class6_2.Border1,
                                class6_2.Border2, 90f))
                    {
                        brush.SetSigmaBellShape(0.5f);
                        using (Pen pen = new Pen(brush))
                        {
                            graphics_0.DrawLine(pen, (int) (rectangle.X + x), (int) (rectangle.Top + 1),
                                (int) (rectangle.X + x), (int) (rectangle.Bottom - 1));
                        }
                    }
                    this.method_9(graphics_0, rectangle, class6_0);
                }
            }
        }
        ...
        private void method_6(Graphics graphics_0, ToolStripItem toolStripItem_0, Class6 class6_0)
        {
            Rectangle rectangle = new Rectangle(2, 0, toolStripItem_0.Bounds.Width - 3, toolStripItem_0.Bounds.Height);
            this.method_7(graphics_0, rectangle, class6_0);
        }

        private void method_7(Graphics graphics_0, Rectangle rectangle_0, Class6 class6_0)
        {
            if ((rectangle_0.Width > 0) && (rectangle_0.Height > 0))
            {
                this.method_8(graphics_0, rectangle_0, class6_0);
                this.method_9(graphics_0, rectangle_0, class6_0);
            }
        }

        private void method_8(Graphics graphics_0, Rectangle rectangle_0, Class6 class6_0)
        {
            rectangle_0.Inflate(-1, -1);
            int height = rectangle_0.Height/2;
            Rectangle rect = new Rectangle(rectangle_0.X, rectangle_0.Y, rectangle_0.Width, height);
            Rectangle rectangle2 = new Rectangle(rectangle_0.X, rectangle_0.Y + height, rectangle_0.Width,
            ...
            using (
                LinearGradientBrush brush = new LinearGradientBrush(rectangle3, class6_0.InsideTop1, class6_0.InsideTop2,
                    90f))
            {
                using (
                    LinearGradientBrush brush2 = new LinearGradientBrush(rectangle4, class6_0.InsideBottom1,
                        class6_0.InsideBottom2, 90f))
                {
            ...
            rectangle2 = new Rectangle(rectangle_0.X, rectangle_0.Y + height, rectangle_0.Width,
                rectangle_0.Height - height);
            rectangle3 = rect;
            ...
            rectangle4.Inflate(1, 1);
            using (
                LinearGradientBrush brush3 = new LinearGradientBrush(rectangle3, class6_0.FillTop1, class6_0.FillTop2,
                    90f))
            {
                using (
                    LinearGradientBrush brush4 = new LinearGradientBrush(rectangle4, class6_0.FillBottom1,
                        class6_0.FillBottom2, 90f))
                {
                    rectangle_0.Inflate(-1, -1);
                    height = rectangle_0.Height/2;
                    rect = new Rectangle(rectangle_0.X, rectangle_0.Y, rectangle_0.Width, height);
        ...
        private void method_9(Graphics graphics_0, Rectangle rectangle_0, Class6 class6_0)
        {
            using (new UseAntiAlias(graphics_0))
            {
                ...
                rect.Inflate(1, 1);
                using (
                    LinearGradientBrush brush = new LinearGradientBrush(rect, class6_0.Border1, class6_0.Border2, 90f))
                {
                    brush.SetSigmaBellShape(0.5f);
                    using (Pen pen = new Pen(brush))
                    {
        ...
        private static void old_acctor_mc()
        {
            ...
            _gripLight = _c5;
            _itemContextItemEnabledColors = new Class6(_r1, _r2, _r3, _r4, _r5, _r6, _r7, _r8,
                Color.FromArgb(217, 203, 150), Color.FromArgb(192, 167, 118));
            _itemDisabledColors = new Class6(_c4, _c6, Color.FromArgb(236, 236, 236), Color.FromArgb(230, 230, 230), _c6,
                Color.FromArgb(224, 224, 224), Color.FromArgb(200, 200, 200), Color.FromArgb(210, 210, 210),
                Color.FromArgb(212, 212, 212), Color.FromArgb(195, 195, 195));
            _itemToolItemSelectedColors = new Class6(_r1, _r2, _r3, _r4, _r5, _r6, _r7, _r8, _r9, _rA);
            _itemToolItemPressedColors = new Class6(_rD, _rE, _rF, _rG, _rH, _rI, _rJ, _rK, _r9, _rA);
            _itemToolItemCheckedColors = new Class6(_rL, _rM, _rN, _rO, _rP, _rQ, _rR, _rS, _r9, _rA);
            _itemToolItemCheckPressColors = new Class6(_rT, _rU, _rV, _rW, _rX, _rI, _rY, _rZ, _r9, _rA);
        ...
        {
            if ((toolStripArrowRenderEventArgs_0.ArrowRectangle.Width > 0) &&
                (toolStripArrowRenderEventArgs_0.ArrowRectangle.Height > 0))
            {
                using (
                    GraphicsPath path = this.method_18(toolStripArrowRenderEventArgs_0.Item,
                        toolStripArrowRenderEventArgs_0.ArrowRectangle, toolStripArrowRenderEventArgs_0.Direction))
                {
        ...
        protected override void OnRenderDropDownButtonBackground(
            ToolStripItemRenderEventArgs toolStripItemRenderEventArgs_0)
        {
            if (toolStripItemRenderEventArgs_0.Item.Selected || toolStripItemRenderEventArgs_0.Item.Pressed)
            {
                this.method_1(toolStripItemRenderEventArgs_0.Graphics, toolStripItemRenderEventArgs_0.Item,
                    toolStripItemRenderEventArgs_0.ToolStrip);
            }
        }

        protected override void OnRenderImageMargin(ToolStripRenderEventArgs toolStripRenderEventArgs_0)
        {
            if ((toolStripRenderEventArgs_0.ToolStrip is ContextMenuStrip) ||
                (toolStripRenderEventArgs_0.ToolStrip is ToolStripDropDownMenu))
            {
                ...
                using (Pen pen = new Pen(_separatorMenuLight))
                {
                    using (Pen pen2 = new Pen(_separatorMenuDark))
                    {
                        if (!flag)
                        {
                            toolStripRenderEventArgs_0.Graphics.DrawLine(pen, affectedBounds.Right, affectedBounds.Top,
                                affectedBounds.Right, affectedBounds.Bottom);
                            toolStripRenderEventArgs_0.Graphics.DrawLine(pen2, affectedBounds.Right - 1,
                                affectedBounds.Top, affectedBounds.Right - 1, affectedBounds.Bottom);
                        }
                        else
                        {
                            toolStripRenderEventArgs_0.Graphics.DrawLine(pen, affectedBounds.Left - 1,
                                affectedBounds.Top, affectedBounds.Left - 1, affectedBounds.Bottom);
                            toolStripRenderEventArgs_0.Graphics.DrawLine(pen2, affectedBounds.Left, affectedBounds.Top,
                                affectedBounds.Left, affectedBounds.Bottom);
                        }
                    }
                    return;
                }
        ...
        {
            if ((toolStripItemImageRenderEventArgs_0.ToolStrip is ContextMenuStrip) ||
                (toolStripItemImageRenderEventArgs_0.ToolStrip is ToolStripDropDownMenu))
            {
                if (toolStripItemImageRenderEventArgs_0.Image != null)
                {
                    if (toolStripItemImageRenderEventArgs_0.Item.Enabled)
                    {
                        toolStripItemImageRenderEventArgs_0.Graphics.DrawImage(
                            toolStripItemImageRenderEventArgs_0.Image,
                            toolStripItemImageRenderEventArgs_0.ImageRectangle);
                    }
                    else
                    {
                        ControlPaint.DrawImageDisabled(toolStripItemImageRenderEventArgs_0.Graphics,
                            toolStripItemImageRenderEventArgs_0.Image,
                            toolStripItemImageRenderEventArgs_0.ImageRectangle.X,
                            toolStripItemImageRenderEventArgs_0.ImageRectangle.Y, Color.Transparent);
                    }
                }
            }
            else
        ...
        {
            if ((((toolStripItemTextRenderEventArgs_0.ToolStrip is MenuStrip) ||
                  (toolStripItemTextRenderEventArgs_0.ToolStrip != null)) ||
                 (toolStripItemTextRenderEventArgs_0.ToolStrip is ContextMenuStrip)) ||
                (toolStripItemTextRenderEventArgs_0.ToolStrip is ToolStripDropDownMenu))
            {
                if (!toolStripItemTextRenderEventArgs_0.Item.Enabled)
                {
                    ...
                    !((!(toolStripItemTextRenderEventArgs_0.ToolStrip is MenuStrip) ||
                       toolStripItemTextRenderEventArgs_0.Item.Pressed) ||
                      toolStripItemTextRenderEventArgs_0.Item.Selected))
                {
                    toolStripItemTextRenderEventArgs_0.TextColor = _textMenuStripItem;
                }
                else if (
                    !((!(toolStripItemTextRenderEventArgs_0.ToolStrip is StatusStrip) ||
                       toolStripItemTextRenderEventArgs_0.Item.Pressed) ||
                      toolStripItemTextRenderEventArgs_0.Item.Selected))
                {
        ...
        protected override void OnRenderMenuItemBackground(ToolStripItemRenderEventArgs toolStripItemRenderEventArgs_0)
        {
            if (((toolStripItemRenderEventArgs_0.ToolStrip is MenuStrip) ||
                 (toolStripItemRenderEventArgs_0.ToolStrip is ContextMenuStrip)) ||
                (toolStripItemRenderEventArgs_0.ToolStrip is ToolStripDropDownMenu))
            {
                if (toolStripItemRenderEventArgs_0.Item.Pressed &&
                    (toolStripItemRenderEventArgs_0.ToolStrip is MenuStrip))
                {
                ...
                else if (toolStripItemRenderEventArgs_0.Item.Selected)
                {
                    if (toolStripItemRenderEventArgs_0.Item.Enabled)
                    {
                        if (toolStripItemRenderEventArgs_0.ToolStrip is MenuStrip)
                        {
                            this.method_3(toolStripItemRenderEventArgs_0.Graphics, toolStripItemRenderEventArgs_0.Item,
                                _itemToolItemSelectedColors);
                        }
                        else
                        {
                            this.method_6(toolStripItemRenderEventArgs_0.Graphics, toolStripItemRenderEventArgs_0.Item,
                    ...
                    else
                    {
                        ...
                        if (!toolStripItemRenderEventArgs_0.Item.Bounds.Contains(pt))
                        {
                            if (toolStripItemRenderEventArgs_0.ToolStrip is MenuStrip)
                            {
                                this.method_3(toolStripItemRenderEventArgs_0.Graphics,
                                    toolStripItemRenderEventArgs_0.Item, _itemDisabledColors);
                            }
                            else
                            {
                                this.method_6(toolStripItemRenderEventArgs_0.Graphics,
                                    toolStripItemRenderEventArgs_0.Item, _itemDisabledColors);
                            }
                        }
                    }
        ...
        protected override void OnRenderSeparator(ToolStripSeparatorRenderEventArgs toolStripSeparatorRenderEventArgs_0)
        {
            Pen pen;
            Pen pen2;
            if ((toolStripSeparatorRenderEventArgs_0.ToolStrip is ContextMenuStrip) ||
                (toolStripSeparatorRenderEventArgs_0.ToolStrip is ToolStripDropDownMenu))
            {
                using (pen = new Pen(_separatorMenuLight))
                {
                    using (pen2 = new Pen(_separatorMenuDark))
                    {
                        this.method_11(toolStripSeparatorRenderEventArgs_0.Graphics,
                            toolStripSeparatorRenderEventArgs_0.Vertical,
                            toolStripSeparatorRenderEventArgs_0.Item.Bounds, pen, pen2, _separatorInset,
                            toolStripSeparatorRenderEventArgs_0.ToolStrip.RightToLeft == RightToLeft.Yes);
                    }
                    return;
                }
            }
            if (toolStripSeparatorRenderEventArgs_0.ToolStrip is StatusStrip)
            {
                using (pen = new Pen(base.ColorTable.SeparatorLight))
                {
                    using (pen2 = new Pen(base.ColorTable.SeparatorDark))
                    {
                        this.method_11(toolStripSeparatorRenderEventArgs_0.Graphics,
                            toolStripSeparatorRenderEventArgs_0.Vertical,
                            toolStripSeparatorRenderEventArgs_0.Item.Bounds, pen, pen2, 0, false);
                    }
                    return;
                }
            }
            ...
            ToolStripItemRenderEventArgs toolStripItemRenderEventArgs_0)
        {
            if (toolStripItemRenderEventArgs_0.Item.Selected || toolStripItemRenderEventArgs_0.Item.Pressed)
            {
                ...
                this.OnRenderArrow(new ToolStripArrowRenderEventArgs(toolStripItemRenderEventArgs_0.Graphics, item,
                    dropDownButtonBounds, SystemColors.ControlText, ArrowDirection.Down));
            }
            else
            {
        ...
        protected override void OnRenderStatusStripSizingGrip(ToolStripRenderEventArgs toolStripRenderEventArgs_0)
        {
            using (SolidBrush brush = new SolidBrush(_gripDark))
            {
                using (SolidBrush brush2 = new SolidBrush(_gripLight))
                {
                    ...
                    {
                        int num3 = flag
                            ? (toolStripRenderEventArgs_0.AffectedBounds.Left + 1)
                            : ((toolStripRenderEventArgs_0.AffectedBounds.Right - (_gripSize*2)) + 1);
                        for (int j = 0; j < i; j++)
                        {
        ...
        protected override void OnRenderToolStripBackground(ToolStripRenderEventArgs toolStripRenderEventArgs_0)
        {
                ...
                (toolStripRenderEventArgs_0.ToolStrip is ToolStripDropDownMenu))
            {
                ...
                {
                    using (
                        GraphicsPath path2 = this.method_16(toolStripRenderEventArgs_0.AffectedBounds, _cutContextMenu))
                    {
            ...
            {
                RectangleF rect = new RectangleF(0f, 1.5f, (float) toolStripRenderEventArgs_0.ToolStrip.Width,
                    (float) (toolStripRenderEventArgs_0.ToolStrip.Height - 2));
                if ((rect.Width <= 0f) || (rect.Height <= 0f))
                {
                    return;
                }
                using (
                    LinearGradientBrush brush2 = new LinearGradientBrush(rect, base.ColorTable.StatusStripGradientBegin,
                        base.ColorTable.StatusStripGradientEnd, 90f))
                {
        ...
        protected override void OnRenderToolStripBorder(ToolStripRenderEventArgs toolStripRenderEventArgs_0)
        {
                ...
                (toolStripRenderEventArgs_0.ToolStrip is ToolStripDropDownMenu))
            {
                if (!toolStripRenderEventArgs_0.ConnectedArea.IsEmpty)
                {
                    using (SolidBrush brush = new SolidBrush(_contextMenuBack))
                    {
                        toolStripRenderEventArgs_0.Graphics.FillRectangle(brush,
                            toolStripRenderEventArgs_0.ConnectedArea);
                    }
                }
                using (
                    GraphicsPath path = this.method_12(toolStripRenderEventArgs_0.AffectedBounds,
                        toolStripRenderEventArgs_0.ConnectedArea, _cutContextMenu))
                {
                    using (
                        GraphicsPath path2 = this.method_15(toolStripRenderEventArgs_0.AffectedBounds,
                            toolStripRenderEventArgs_0.ConnectedArea, _cutContextMenu))
                    {
                        using (
                            GraphicsPath path3 = this.method_17(toolStripRenderEventArgs_0.AffectedBounds,
                                toolStripRenderEventArgs_0.ConnectedArea, _cutContextMenu))
                        {
                            using (Pen pen = new Pen(base.ColorTable.MenuBorder))
                            {
                                using (Pen pen2 = new Pen(_separatorMenuLight))
                                {
                                    using (new UseClipping(toolStripRenderEventArgs_0.Graphics, path3))
                                    {
                                        ...
                                        toolStripRenderEventArgs_0.Graphics.DrawLine(pen,
                                            toolStripRenderEventArgs_0.AffectedBounds.Right,
                                            toolStripRenderEventArgs_0.AffectedBounds.Bottom,
                                            toolStripRenderEventArgs_0.AffectedBounds.Right - 1,
                                            toolStripRenderEventArgs_0.AffectedBounds.Bottom - 1);
                                    }
                                    return;
                                }
                            }
            ...
            if (toolStripRenderEventArgs_0.ToolStrip is StatusStrip)
            {
                using (Pen pen3 = new Pen(_statusStripBorderDark))
                {
                    ...
                    {
                        toolStripRenderEventArgs_0.Graphics.DrawLine(pen3, 0, 0,
                            toolStripRenderEventArgs_0.ToolStrip.Width, 0);
                        toolStripRenderEventArgs_0.Graphics.DrawLine(pen4, 0, 1,
                            toolStripRenderEventArgs_0.ToolStrip.Width, 1);
                    }
                    return;
                }
            }
        ...
        protected override void OnRenderToolStripContentPanelBackground(
            ToolStripContentPanelRenderEventArgs toolStripContentPanelRenderEventArgs_0)
        {
            base.OnRenderToolStripContentPanelBackground(toolStripContentPanelRenderEventArgs_0);
            if ((toolStripContentPanelRenderEventArgs_0.ToolStripContentPanel.Width > 0) &&
                (toolStripContentPanelRenderEventArgs_0.ToolStripContentPanel.Height > 0))
            {
                using (
                    LinearGradientBrush brush =
                        new LinearGradientBrush(
                            toolStripContentPanelRenderEventArgs_0.ToolStripContentPanel.ClientRectangle,
                            base.ColorTable.ToolStripContentPanelGradientEnd,
                            base.ColorTable.ToolStripContentPanelGradientBegin, 90f))
                {
                    toolStripContentPanelRenderEventArgs_0.Graphics.FillRectangle(brush,
                        toolStripContentPanelRenderEventArgs_0.ToolStripContentPanel.ClientRectangle);
                }
            }
        }
        ...
        private class Class6
        {
            ...
            public Class6(Color color_0, Color color_1, Color color_2, Color color_3, Color color_4, Color color_5,
                Color color_6, Color color_7, Color color_8, Color color_9)
            {
