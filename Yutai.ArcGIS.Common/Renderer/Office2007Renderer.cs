...
namespace Yutai.ArcGIS.Common.Renderer
{
    public class Office2007Renderer : ToolStripProfessionalRenderer
    {
        ...
        private void method_4(Graphics graphics_0, ToolStripSplitButton toolStripSplitButton_0, Class6 class6_0, Class6 class6_1, Class6 class6_2)
        {
            ...
            if ((((rectangle.Width > 0) && (dropDownButtonBounds.Width > 0)) && (rectangle.Height > 0)) && (dropDownButtonBounds.Height > 0))
            {
                ...
                using (this.method_13(rectangle, _cutMenuItemBack))
                {
                    ...
                    using (LinearGradientBrush brush = new LinearGradientBrush(new Rectangle(rectangle.X + x, rectangle.Top, 1, rectangle.Height + 1), class6_2.Border1, class6_2.Border2, 90f))
                    {
        ...
        private void method_8(Graphics graphics_0, Rectangle rectangle_0, Class6 class6_0)
        {
            ...
            using (LinearGradientBrush brush = new LinearGradientBrush(rectangle3, class6_0.InsideTop1, class6_0.InsideTop2, 90f))
            {
                using (LinearGradientBrush brush2 = new LinearGradientBrush(rectangle4, class6_0.InsideBottom1, class6_0.InsideBottom2, 90f))
                {
            ...
            rectangle3.Inflate(1, 1);
            rectangle4.Inflate(1, 1);
            using (LinearGradientBrush brush3 = new LinearGradientBrush(rectangle3, class6_0.FillTop1, class6_0.FillTop2, 90f))
            {
                using (LinearGradientBrush brush4 = new LinearGradientBrush(rectangle4, class6_0.FillBottom1, class6_0.FillBottom2, 90f))
                {
                    rectangle_0.Inflate(-1, -1);
                    height = rectangle_0.Height / 2;
                    rect = new Rectangle(rectangle_0.X, rectangle_0.Y, rectangle_0.Width, height);
        ...
        private void method_9(Graphics graphics_0, Rectangle rectangle_0, Class6 class6_0)
        {
            using (new UseAntiAlias(graphics_0))
            {
                ...
                rect.Inflate(1, 1);
                using (LinearGradientBrush brush = new LinearGradientBrush(rect, class6_0.Border1, class6_0.Border2, 90f))
                {
                    brush.SetSigmaBellShape(0.5f);
                    using (Pen pen = new Pen(brush))
                    {
        ...
        private static void old_acctor_mc()
        {
            ...
            _gripLight = _c5;
            _itemContextItemEnabledColors = new Class6(_r1, _r2, _r3, _r4, _r5, _r6, _r7, _r8, Color.FromArgb(0xd9, 0xcb, 150), Color.FromArgb(0xc0, 0xa7, 0x76));
            _itemDisabledColors = new Class6(_c4, _c6, Color.FromArgb(0xec, 0xec, 0xec), Color.FromArgb(230, 230, 230), _c6, Color.FromArgb(0xe0, 0xe0, 0xe0), Color.FromArgb(200, 200, 200), Color.FromArgb(210, 210, 210), Color.FromArgb(0xd4, 0xd4, 0xd4), Color.FromArgb(0xc3, 0xc3, 0xc3));
        ...
        private class Class6
        {
            ...
            public Class6(Color color_0, Color color_1, Color color_2, Color color_3, Color color_4, Color color_5, Color color_6, Color color_7, Color color_8, Color color_9)
            {
