...
namespace Yutai.ArcGIS.Common.Editor
{
	public class CreateFeatureTool
	{
		...
		public static void CreateDimensionFeature(IDimensionShape pDimensionShape, esriDimensionType pDimensionType, IActiveView pActiveView, IFeatureLayer pFeatureLayer)
		{
