                ...
                if (feature1.Shape.GeometryType == esriGeometryType.esriGeometryPolyline)
                {
                    ...
                    if (
                        ((IHitTest) feature1.Shape).HitTest(ipoint_0, double_0,
                            esriGeometryHitPartType.esriGeometryPartEndpoint, pointClass, ref num, ref num1, ref num2,
        ...
        private IPoint SnapVertexPoint(IPoint ipoint_0, IFeatureCache2 ifeatureCache2_0, double double_0)
        {
            ...
            for (int i = 0; i < ifeatureCache2_0.Count; i++)
            {
                    ...
                    : feature1.Shape.GeometryType == esriGeometryType.esriGeometryPolygon))
                {
                    ...
                    if (
                        ((IHitTest) feature1.Shape).HitTest(ipoint_0, double_0,
                            esriGeometryHitPartType.esriGeometryPartVertex, pointClass, ref num, ref num1, ref num2,
                            ref flag) && num <= double_0)
                    {
                        if (num3 < 0)
                        {
