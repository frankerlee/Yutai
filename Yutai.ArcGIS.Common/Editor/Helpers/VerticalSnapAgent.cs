		...
		public bool Snap(IGeometry igeometry_0, IPoint ipoint_0, double double_0)
		{
			...
			while (true)
			{
				if (num3 < this.ifeatureCache_0.Count)
				{
					...
					if (shape.HitTest(ipoint0, double_0, esriGeometryHitPartType.esriGeometryPartBoundary, pointClass, ref num, ref num1, ref num2, ref flag1))
					{
						ILine segment = ((ISegmentCollection)((IGeometryCollection)shape).Geometry[num1]).Segment[num2] as ILine;
						if (segment != null)
						{
