...
namespace Yutai.ArcGIS.Common.Editor.Helpers
{
    public class SketchToolAssist
    {
        ...
        {
            get { return SketchToolAssist.m_pAnchorPoint; }
        }

        public static ITask CurrentTask { get; set; }

        public static IDisplayFeedback Feedback
        {
            get { return SketchToolAssist.m_Feedback; }
            set { SketchToolAssist.m_Feedback = value; }
        }

        public static double FixDirection { get; set; }

        public static double FixLength { get; set; }

        public static DrawTempGeometry IsDrawTempLine { get; set; }

        public static bool IsFixDirection { get; set; }

        public static bool IsFixLength { get; set; }

        public static IPoint LastPoint { get; set; }

        public static enumLineType LineType { get; set; }

        private static IMap Map { get; set; }

        public static IPoint StartPoint { get; set; }

        public static SysGrants SysGrants { get; protected set; }

        public static IGeometry TempLine { get; set; }
