	...
	public class SnapHelper
	{
		...
		private ISnappingResult method_0(IPoint ipoint_1)
		{
			...
			if (engineSnapEnvironment is ISnapEnvironment)
			{
				...
				if ((snapEnvironment == null || !ApplicationRef.AppContext.Config.UseSnap ? false : snapEnvironment.SnapPoint(pointClass, ipoint_1)))
				{
			...
			else if ((engineSnapEnvironment == null || !ApplicationRef.AppContext.Config.UseSnap ? false : engineSnapEnvironment.SnapPoint(ipoint_1)))
			{
		...
		public void Snap2Point(IPoint ipoint_1, IPoint ipoint_2, esriSimpleMarkerStyle esriSimpleMarkerStyle_0)
		{
			...
			if (!Editor.UseOldSnap)
			{
				...
				if (snappingResult == null)
				{
					...
					this.ianchorPoint_0.MoveTo(this.AnchorPoint, (this._appContext.MapControl.Map as IActiveView).ScreenDisplay);
				}
				else
				{
		...
		public bool Snap2Point2(IPoint ipoint_1, IPoint ipoint_2, esriSimpleMarkerStyle esriSimpleMarkerStyle_0)
		{
			...
			else
			{
				...
				{
					if ((!ApplicationRef.AppContext.Config.UseSnap ? true : !(this.iengineSnapEnvironment_0 as SnapEnvironment).SnapPoint(ipoint_1, ipoint_2)))
					{
						this.bool_0 = false;
						if (this.ianchorPoint_0 != null)
						{
				...
				else if ((this.iengineSnapEnvironment_0 == null || !ApplicationRef.AppContext.Config.UseSnap ? true : !this.iengineSnapEnvironment_0.SnapPoint(ipoint_2)))
				{
					this.bool_0 = false;
					if (this.ianchorPoint_0 != null)
					{
