                        ...
                        if (string_0.Length != 0)
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    iapplication0.ShowCommandString(
                                        string.Concat("找到", selectionCount.ToString(), "个对象"), CommandTipsType.CTTLog);
                                    this.ShowCommandLine();
                                }
                            }
                        }
                    ...
                    else if (this.int_0 == 1)
                    {
                        ...
                        if ((int) strArrays.Length >= 2)
                        {
                            ...
                            if (this.idisplayFeedback_0 == null)
                            {
                                ...
                                {
                                    IPolyline polyline = Editor.TrimPolyLine(this._appContext.MapControl.Map,
                                        hitLineFeature.Shape, pointClass, mapUnits);
