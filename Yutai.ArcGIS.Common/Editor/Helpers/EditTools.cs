...
namespace Yutai.ArcGIS.Common.Editor.Helpers
{
    public class EditTools
    {
        ...
        {
            get { return EditTools.m_CurrentPoint; }
        }
        ...
        {
            get { return EditTools.m_pEditFeature; }
            set { EditTools.m_pEditFeature = value; }
        }
        ...
        public bool Enabled
        {
            get
            {
                ...
                if (this._appContext.MapControl.Map == null)
                {
                    ...
                    !(this._appContext.MapControl.Map.LayerCount == 0 || Editor.EditWorkspace == null
                        ? false
                        : Editor.EditMap != null))
                {
        ...
        {
            get { return EditTools.m_HitType; }
            set { EditTools.m_HitType = value; }
        }

        public static bool IsAutoShowAttribute { get; set; }

        public static int PartIndex
        {
            get { return EditTools.m_PartIndex; }
            set { EditTools.m_PartIndex = value; }
        }

        public static int PointIndex
        {
            get { return EditTools.m_PointIndex; }
            set { EditTools.m_PointIndex = value; }
        }

        public IPopuMenuWrap PopuMenu
        {
            set { this.m_PopuMenuWrap = value; }
        }

        public static IPoint SelectionSetAnchorPoint
        {
            get { return EditTools.m_SelectionSetAnchorPoint; }
            set { EditTools.m_SelectionSetAnchorPoint = value; }
        }
        ...
        public EditTools(IAppContext context)
        {
            ...
            this.m_Cursor =
                new System.Windows.Forms.Cursor(
                    this.GetType().Assembly.GetManifestResourceStream("Yutai.ArcGIS.Common.Cursor.Edit.cur"));
            ...
            if (!_appContext.RibbonMenu.GetContextMenuVisible())
            {
                if ((!this.bool_12 ? true : this.p_HitType != EditTools.m_HitType))
                {
                    ...
                    if (EditTools.m_HitType != HitType.None)
                    {
                        ...
                        {
                            "Edit_MoveVertexToPoint", "Edit_MoveVertex", "-", "Edit_MoveFeatureToPoint",
                            "Edit_MoveFeatures", "-", "Edit_AddPointInGeometry", "-", "ViewGeometryInfo"
                        };
                    ...
                    else
                    {
                        strArrays = new string[]
                        {
                            "Edit_Copy", "Edit_Paste", "Edit_CopyFeatureTools", "-", "Edit_Zoom2Selection",
                            "Edit_DeleteSelection", "Edit_ClearSelection", "-", "Edit_Attribute"
                        };
                        strArrays1 = strArrays;
                    }
                    _contextMenuKeys = strArrays;
        ...
        private bool method_0(IPoint ipoint_5, out bool bool_13)
        {
            ...
            if (this._appContext.MapControl.Map.SelectionCount >= 1)
            {
                ...
                {
                    searchTolerance =
                        (double) (this._appContext as IAppContext).Config.SelectionEnvironment.SearchTolerance;
                }
                searchTolerance = CommonHelper.ConvertPixelsToMapUnits((IActiveView) this._appContext.MapControl.Map,
                    searchTolerance);
                ...
                if (feature != null)
                {
                    ...
                    if ((shape.GeometryType == esriGeometryType.esriGeometryPoint
                        ? false
                        : shape.GeometryType != esriGeometryType.esriGeometryMultipoint))
                    {
                        ...
                        switch (shape.GeometryType)
                        {
                            ...
                            {
                                if (
                                    !this.method_3(searchTolerance, ipoint_5, shape, out point, ref num1, ref num2,
                                        ref num, out flag2))
                                {
                                    flag = false;
                                    return flag;
                                ...
                                else
                                {
                                    ...
                                    if (flag2)
                                    {
                                        ...
                                        ((ILineMovePointFeedback) this.m_DisplayFeedback).Start((IPolyline) shape, num,
                                            ipoint_5);
                                        break;
                                    }
                                    else
                                    {
                                        if (Editor.DrawNode)
                                        {
                                            ...
                                            this.method_3(searchTolerance, ipoint_5, this.m_Geometry, out point,
                                                ref num1, ref num2, ref num, out flag2);
                                            bool_13 = true;
                                        }
                                        flag = true;
                                        return flag;
                            ...
                            case esriGeometryType.esriGeometryPolygon:
                            {
                                ...
                                else
                                {
                                    ...
                                    unit = string.Concat(" 平方",
                                        CommonHelper.GetUnit(this._appContext.MapControl.Map.MapUnits));
                                    ...
                                    if (flag2)
                                    {
                                        ...
                                        IPolygonMovePointFeedback idisplayFeedback0 =
                                            (PolygonMovePointFeedback) this.m_DisplayFeedback;
                                        IPolygon polygonClass = new Polygon() as IPolygon;
                                        object missing = Type.Missing;
                                        (polygonClass as IGeometryCollection).AddGeometry(
                                            ((IGeometryCollection) this.m_Geometry).Geometry[num2], ref missing,
                                            ref missing);
                            ...
                            case esriGeometryType.esriGeometryPolyline:
                            {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        this.method_3(searchTolerance, ipoint_5, this.m_Geometry, out point, ref num1,
                                            ref num2, ref num, out flag2);
                                        this.bool_3 = false;
                                            ...
                                            new System.Windows.Forms.Cursor(
                                                this.GetType()
                                                    .Assembly.GetManifestResourceStream(
                                                        "Yutai.ArcGIS.Common.Cursor.VertexEdit.cur"));
                                        flag = true;
                                        return flag;
                                    }
                                }
                            ...
                            case esriGeometryType.esriGeometryPolygon:
                            {
                                ...
                                else
                                {
                                    ...
                                    if (flag2)
                                    {
                                        ...
                                        ((PolygonMovePointFeedback) this.m_DisplayFeedback).Start((IPolygon) shape, num,
                                            ipoint_5);
                                        break;
                                    }
                                    else
        ...
        {
            double num;
            num = (!(this._appContext is IAppContext)
                ? 8
                : (double) (this._appContext as IAppContext).Config.SelectionEnvironment.SearchTolerance);
            return num;
        }
        ...
        private ISnappingResult SnapPoint(IPoint pPoint, IActiveView pActiveView)
        {
            ...
            if (engineSnapEnvironment is ISnapEnvironment)
            {
                ...
                if ((snapEnvironment == null || !ApplicationRef.AppContext.Config.UseSnap
                    ? false
                    : snapEnvironment.SnapPoint(this.ipoint_3, pPoint)))
                {
                ...
                ? false
                : engineSnapEnvironment.SnapPoint(pPoint)))
            {
        ...
        private void method_16(IPoint ipoint_5, IPoint ipoint_6, esriSimpleMarkerStyle esriSimpleMarkerStyle_0)
        {
            ...
            if (!Editor.UseOldSnap)
            {
                ...
                if (snappingResult == null)
                {
                    ...
                    this.m_AnchorPoint.MoveTo(this.ipoint_2,
        ...
        private void method_19()
        {
            if (this._appContext.MapControl.Map.SelectionCount != 0)
            {
                ...
                if (EditTools.m_SelectionSetAnchorPoint != null)
                {
                    ...
                    this._appContext.MapControl.ActiveView.PartialRefresh(esriViewDrawPhase.esriViewGeography, null,
                        envelope);
                }
                            ...
                            case esriGeometryType.esriGeometryPolyline:
                            {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        geometry =
                                            (IPath)
                                            ((IGeometryCollection) this.m_Geometry).Geometry[EditTools.m_PartIndex];
                                        value = Missing.Value;
                                        ...
                                        this.method_3(searchTolerance, this.ipoint_4, this.m_Geometry, out this.ipoint_4,
                                            ref num1, ref EditTools.m_PartIndex, ref EditTools.m_PointIndex, out flag2);
                                        this.bool_3 = false;
                                        this.m_Cursor.Dispose();
                                        this.m_Cursor =
                                            new System.Windows.Forms.Cursor(
        ...
        private void View_AfterDraw(IDisplay pDisplay, esriViewDrawPhase pViewDrawPhase)
        {
            if (this.Enabled)
            {
                if ((!Editor.DrawNode ? false : this._appContext.MapControl.Map.SelectionCount == 1))
                {
                    ...
                    if (feature != null)
                    {
                        IPointCollection shape =
                            (feature.Class as IFeatureClass).GetFeature(feature.OID).Shape as IPointCollection;
                        if (shape != null)
                        {
        ...
        private void View_ActiveHookChanged(object object_0)
        {
            if (this.m_ActiveViewEvents != null)
            {
                try
                {
                    ...
                    this.m_ActiveViewEvents.SelectionChanged -=
                        new IActiveViewEvents_SelectionChangedEventHandler(this.View_SelectionChanged);
                }
                catch
                {
                }
        ...
        private bool method_3(double double_0, IPoint ipoint_5, IGeometry igeometry_1, out IPoint ipoint_6,
            ref double double_1, ref int int_2, ref int int_3, out bool bool_13)
        {
            bool flag;
            bool flag1 = false;
            ...
            bool flag2 = false;
            if (
                !(igeometry_1.GeometryType == esriGeometryType.esriGeometryPoint
                    ? false
                    : igeometry_1.GeometryType != esriGeometryType.esriGeometryMultipoint))
            {
                if (
                    !igeometry1.HitTest(ipoint_5, double_0, esriGeometryHitPartType.esriGeometryPartVertex, ipoint_6,
                        ref double_1, ref int_2, ref int_3, ref flag2))
                {
                    bool_13 = false;
                }
                else
            ...
            else if (igeometry1.HitTest(ipoint_5, double_0, esriGeometryHitPartType.esriGeometryPartVertex, ipoint_6,
                ref double_1, ref int_2, ref int_3, ref flag2))
            {
                bool_13 = true;
                flag = true;
            }
            else if (igeometry1.HitTest(ipoint_5, double_0, esriGeometryHitPartType.esriGeometryPartBoundary, ipoint_6,
                ref double_1, ref int_2, ref int_3, ref flag2))
            {
                bool_13 = false;
                flag = true;
            }
            else if ((igeometry_1.GeometryType == esriGeometryType.esriGeometryEnvelope
                         ? false
                         : igeometry_1.GeometryType != esriGeometryType.esriGeometryPolygon) ||
                     !((IRelationalOperator) igeometry_1).Contains(ipoint_5))
            {
                flag = false;
            }
            else
        ...
        private bool method_4(IPoint ipoint_5, int int_2)
        {
            ...
            if (this._appContext.MapControl.Map.SelectionCount >= 1)
            {
                ...
                if (this._appContext.MapControl.Map.SelectionCount != 1)
                {
                    if ((this._appContext.MapControl.Map.SelectionCount <= 1 ? false : int_2 == 0))
                    {
                        ...
                        if (featureSelection != null)
                        {
                            ...
                            Editor.RefreshLayerWithSelection(this._appContext.MapControl.Map, this.m_Envelope,
                ...
                {
                    this._appContext.MapControl.ActiveView.PartialRefresh(esriViewDrawPhase.esriViewGeoSelection, null,
                        null);
                    flag = true;
                }
            }
        ...
        public void OnCreate(object context)
        {
            ...
            {
                (this._appContext as IAppContextEvents).OnActiveHookChanged +=
                    new OnActiveHookChangedHandler(this.View_ActiveHookChanged);
            }
            if (this.m_ActiveViewEvents != null)
            {
                try
            ...
            if (this._appContext.MapControl.Map != null)
            {
                ...
                try
                {
                    ...
                    m_ActiveViewEvents.SelectionChanged +=
                        new IActiveViewEvents_SelectionChangedEventHandler(this.View_SelectionChanged);
                }
                catch (Exception exception)
                {
        ...
        public void OnKeyUp(int int_2, int int_3)
        {
            ...
            switch (int2)
            {
                case 37:
                {
                    if (int_3 != 1)
                    {
                        Editor.MoveSelectedFeatures(this._appContext.MapControl.Map, Editor.EditWorkspace as IWorkspace,
                            -mapUnits, 0);
                        break;
                    }
                    else
                ...
                default:
                {
                    if (int2 == 46)
                    {
                        Editor.DeletedSelectedFeatures(this._appContext.MapControl.Map,
                            Editor.EditWorkspace as IWorkspace);
                        break;
                    }
                    else
                    {
        ...
        public void OnMouseDown(int int_2, int int_3, int int_4, int int_5)
        {
            if (int_2 != 2)
            {
                ...
                if (this._appContext.MapControl.Map.SelectionCount != 1 || this.bool_3 || !Editor.DrawNode ||
                    !this.method_2(mapPoint))
                {
                    this.bool_2 = true;
                    if (this.bool_3)
                    {
            ...
            if (int_2 != 2)
            {
                ...
                if ((int_2 != 0 ? true : int_3 != 1))
                {
                    ...
                    else if (this.bool_2)
                    {
                        ...
                        if (int_2 == 1)
                        {
                            if (this.m_DisplayFeedback != null)
                            {
                                ...
                                if ((!this.bool_1 || this.m_Geometry == null || EditTools.m_PartIndex == -1
                                    ? false
                                    : EditTools.m_PointIndex != -1))
                                {
                                    IPointCollection geometry =
                                        (this.m_Geometry as IGeometryCollection).Geometry[EditTools.m_PartIndex] as
                                            IPointCollection;
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    (this.m_DisplayFeedback as IMoveGeometryFeedbackEx).Display =
                                        this._appContext.MapControl.ActiveView.ScreenDisplay;
                                }
                                featureSelection = (IEnumFeature) this._appContext.MapControl.Map.FeatureSelection;
                                featureSelection.Reset();
                                for (i = featureSelection.Next(); i != null; i = featureSelection.Next())
                                ...
                                this.m_Cursor =
                                    new System.Windows.Forms.Cursor(
                                        this.GetType()
                                            .Assembly.GetManifestResourceStream(
                                                "Yutai.ArcGIS.Common.Cursor.EditMove.cur"));
                            }
                        }
                    }
                    ...
                    else
                    {
                        ...
                        double mapUnits =
                            CommonHelper.ConvertPixelsToMapUnits((IActiveView) this._appContext.MapControl.Map, 4);
                        while (true)
                        {
                            if (i == null)
                            {
                            ...
                            else if (!Editor.CheckIsEdit(i.Class as IDataset) ||
                                     !this.method_3(mapUnits, mapPoint, i.Shape, out this.ipoint_4, ref num, ref num2,
                                         ref num1, out flag))
                            {
                                i = featureSelection.Next();
                            }
                            ...
                            else if (!(num2 < 0 ? true : !Editor.DrawNode))
                            {
                                ...
                                this.m_Cursor =
                                    new System.Windows.Forms.Cursor(
                                        this.GetType()
                                            .Assembly.GetManifestResourceStream(
                                                "Yutai.ArcGIS.Common.Cursor.Digitise.cur"));
                                this.bool_11 = true;
                        ...
                        if (!this.bool_11)
                        {
                            ...
                            this.m_Cursor =
                                new System.Windows.Forms.Cursor(
                                    this.GetType()
                                        .Assembly.GetManifestResourceStream("Yutai.ArcGIS.Common.Cursor.Edit.cur"));
                        }
                        this.Init();
                    }
                }
                        ...
                        if (spatialReference != null)
                        {
                            if (spatialReference.IsEmpty)
                            {
                                ...
                                mapUnits =
                                    CommonHelper.ConvertPixelsToMapUnits(
                                        this._appContext.MapControl.Map as IActiveView, this.GetSearchTolerance());
                            ...
                            else
                            {
                                selectionEnvironmentClass =
                                    (this._appContext as IAppContext).Config.SelectionEnvironment;
                            }
                            ...
                            if (this.int_0 != -1)
                            {
                                if (this.int_0 <= int_4)
                                {
                                    selectionEnvironmentClass.LinearSelectionMethod =
                                        esriSpatialRelEnum.esriSpatialRelIntersects;
                                    selectionEnvironmentClass.AreaSelectionMethod =
                                        esriSpatialRelEnum.esriSpatialRelIntersects;
                                }
                                else
                                {
                            ...
                            if (int_3 == 1)
                            {
                                selectionEnvironmentClass.CombinationMethod =
                            ...
                            {
                                selectionEnvironmentClass.CombinationMethod =
                                    esriSelectionResultEnum.esriSelectionResultXOR;
                                flag = false;
                            }
                            ...
                            {
                                this.bool_0 = false;
                                this._appContext.MapControl.Map.SelectByShape(spatialReference,
                                    selectionEnvironmentClass, false);
                                if (Editor.IsRemoveUnEditLayerSelect &&
                                    this._appContext.MapControl.Map.SelectionCount > 0)
                                {
