					...
					if (string_1.Length != 0)
					{
						...
						else
						{
							...
							if (SketchShareEx.StartPoint != null)
							{
								...
								point.Z = num2;
								SketchShareEx.SketchMouseDown(point, this._appContext.MapControl.Map as IActiveView, Editor.CurrentEditTemplate.FeatureLayer);
								SketchShareEx.SketchMouseDown(SketchShareEx.StartPoint, this._appContext.MapControl.Map as IActiveView, Editor.CurrentEditTemplate.FeatureLayer);
							}
						}
					}
					else
