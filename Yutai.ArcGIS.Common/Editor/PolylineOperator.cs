...
namespace Yutai.ArcGIS.Common.Editor
{
	public class PolylineOperator : GeometryOperator
	{
		...
		public IPolyline Cut(IPoint ipoint_0, IPoint ipoint_1, double double_0)
		{
			...
			int num6 = -1;
			int num7 = -1;
			bool flag2 = GeometryOperator.TestGeometryHit(double_0, ipoint_0, mPGeometry, out point, ref num5, ref num6, ref num3, out flag1);
			bool flag3 = flag2;
			if ((!flag2 ? false : !flag1))
			{
				...
				if (flag)
				{
					GeometryOperator.TestGeometryHit(double_0, ipoint_0, mPGeometry, out point, ref num5, ref num6, ref num3, out flag1);
				}
			}
			bool flag4 = GeometryOperator.TestGeometryHit(double_0, ipoint_1, mPGeometry, out point1, ref num5, ref num7, ref num4, out flag1);
			bool flag5 = flag4;
			if ((!flag4 ? false : !flag1))
			{
				...
				if (flag)
				{
					...
					GeometryOperator.TestGeometryHit(double_0, ipoint_1, mPGeometry, out point1, ref num5, ref num7, ref num4, out flag1);
				}
			}
			if ((!flag3 ? true : !flag5))
			{
		...
		public override bool HiTest(double double_0, IPoint ipoint_0, out IPoint ipoint_1, ref double double_1, ref int int_0, ref int int_1, out bool bool_0)
		{
			bool flag;
			...
			bool_0 = false;
			bool flag1 = false;
			if (mPGeometry.HitTest(ipoint_0, double_0, esriGeometryHitPartType.esriGeometryPartVertex, ipoint_1, ref double_1, ref int_0, ref int_1, ref flag1))
			{
				bool_0 = true;
				flag = true;
			}
			else if (!mPGeometry.HitTest(ipoint_0, double_0, esriGeometryHitPartType.esriGeometryPartBoundary, ipoint_1, ref double_1, ref int_0, ref int_1, ref flag1))
			{
				flag = false;
			}
			else
		...
		private IGeometry method_1(IPolyline ipolyline_0, int int_0, int int_1, int int_2, int int_3)
		{
			...
			else
			{
				...
				if (int_3 - int_1 + 1 != geometry.PointCount)
				{
					...
					for (i = 0; i < int_0 - 1; i++)
					{
						polylineClass.AddGeometry((ipolyline0.Geometry[i] as IClone).Clone() as IGeometry, ref value, ref value);
					}
		...
		private IArray method_2(IGeometry igeometry_0, IGeometry igeometry_1)
		{
			...
			{
				IGeometry geometry = ((ITopologicalOperator)igeometry_0).Intersect(igeometry_1, esriGeometryDimension.esriGeometry0Dimension);
				if (geometry != null)
				{
		...
		private ISegment method_3(ISegment isegment_0, IPoint ipoint_0)
		{
			...
			else if (isegment_0.GeometryType == esriGeometryType.esriGeometryEllipticArc)
			{
				...
				(lineClass as IConstructEllipticArc).ConstructTwoPointsEnvelope(pointClass, point, envelopeClass, ((isegment_0 as IEllipticArc).IsCounterClockwise ? esriArcOrientation.esriArcCounterClockwise : esriArcOrientation.esriArcClockwise));
				segment = lineClass;
			}
