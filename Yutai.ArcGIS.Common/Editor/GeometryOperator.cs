...
namespace Yutai.ArcGIS.Common.Editor
{
	public abstract class GeometryOperator
	{
		...
		public static void CreateVerticalLOSPatches(bool bool_0, IPoint ipoint_0, IPoint ipoint_1, IPolyline ipolyline_0, IPolyline ipolyline_1, IGeometryCollection igeometryCollection_0, IGeometryCollection igeometryCollection_1, out double double_0)
		{
			int i;
		...
		public abstract bool HiTest(double double_0, IPoint ipoint_0, out IPoint ipoint_1, ref double double_1, ref int int_0, ref int int_1, out bool bool_0);
		...
		public static void RelpacePoint(IPoint ipoint_0, IGeometry igeometry_0, int int_0, int int_1)
		{
			...
			if (isClosed && int_1 == 0)
			{
				((IPointCollection)geometry).ReplacePointCollection((geometry as IPointCollection).PointCount - 1, 1, multipointClass);
			}
		}
		...
		public static bool TestGeometryHit(double double_0, IPoint ipoint_0, IGeometry igeometry_0, out IPoint ipoint_1, ref double double_1, ref int int_0, ref int int_1, out bool bool_0)
		{
			bool flag;
			bool flag1 = false;
			...
			bool_0 = false;
			bool flag2 = false;
			if (!(igeometry_0.GeometryType == esriGeometryType.esriGeometryPoint ? false : igeometry_0.GeometryType != esriGeometryType.esriGeometryMultipoint))
			{
				if (!igeometry0.HitTest(ipoint_0, double_0, esriGeometryHitPartType.esriGeometryPartVertex, ipoint_1, ref double_1, ref int_0, ref int_1, ref flag2))
				{
					bool_0 = false;
				}
				else
			...
			else if (igeometry0.HitTest(ipoint_0, double_0, esriGeometryHitPartType.esriGeometryPartVertex, ipoint_1, ref double_1, ref int_0, ref int_1, ref flag2))
			{
				bool_0 = true;
				flag = true;
			}
			else if (igeometry0.HitTest(ipoint_0, double_0, esriGeometryHitPartType.esriGeometryPartBoundary, ipoint_1, ref double_1, ref int_0, ref int_1, ref flag2))
			{
				bool_0 = false;
				flag = true;
			}
			else if ((igeometry_0.GeometryType == esriGeometryType.esriGeometryEnvelope ? false : igeometry_0.GeometryType != esriGeometryType.esriGeometryPolygon) || !((IRelationalOperator)igeometry_0).Contains(ipoint_0))
			{
				flag = false;
			}
			else
