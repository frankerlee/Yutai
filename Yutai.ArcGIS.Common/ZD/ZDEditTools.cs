...
namespace Yutai.ArcGIS.Common.ZD
{
    public class ZDEditTools
    {
        ...
        public static System.DateTime StartEditDateTime { get; set; }
        ...
        private static void WriteHistoryLine(IFeature ifeature_0, IFeature ifeature_1, int int_0,
        ...
        private static void WriteHistoryLine(System.Collections.Generic.List<IFeature> list_0, IFeature ifeature_0,
            System.Collections.Generic.List<IFeature> list_1, int int_0, System.DateTime dateTime_0)
        {
            int num = 0;
            foreach (IFeature current in list_0)
            {
        ...
        public static System.Collections.Generic.List<HitFeatureInfo> GetHitInfo(IFeature ifeature_0, IPoint ipoint_0)
        {
            ...
            foreach (IFeature current in list2)
            {
                ...
                int num2 = 0;
                bool flag = false;
                if ((shapeCopy as IHitTest).HitTest(ipoint_0, 1E-05, esriGeometryHitPartType.esriGeometryPartVertex,
                    hitPoint, ref num, ref partIndex, ref num2, ref flag))
                {
                    ...
                    (shapeCopy as IHitTest).HitTest(ipoint_0, 1E-05, esriGeometryHitPartType.esriGeometryPartBoundary,
                        hitPoint, ref num, ref partIndex, ref num2, ref flag) && num < 0.0001)
                {
                    list.Add(new HitFeatureInfo
                    {
                        Feature = current,
