	...
	public class ZDRegister
	{
		public static bool Register(IFeatureClass ifeatureClass_0, string string_0)
		{
			...
			else
			{
				...
				string finalName = WorkspaceOperator.GetFinalName2(featureWorkspace as IWorkspace, esriDatasetType.esriDTFeatureClass, "", array[array.Length - 1], "_His");
				...
				string workspaceConnectInfo = WorkspaceOperator.GetWorkspaceConnectInfo((ifeatureClass_0 as IDataset).Workspace);
				...
				IFeatureClass featureClass = featureWorkspace.CreateFeatureClass(finalName, fields, null, null, esriFeatureType.esriFTSimple, "shape", "");
		...
		public static bool UnRegister(IFeatureClass ifeatureClass_0)
		{
			...
			else
			{
				...
				string workspaceConnectInfo = WorkspaceOperator.GetWorkspaceConnectInfo((ifeatureClass_0 as IDataset).Workspace);
				queryFilter.WhereClause = string.Format("FeatureClassName='{0}' and GDBConnectInfo='{1}'", array[array.Length - 1], workspaceConnectInfo);
				string arg = "";
				string name = "";
