...
namespace Yutai.ArcGIS.Common.ZD
{
	public class ZDChangeHistoryInfo2
	{
		...
		public string OriginOIDs
		{
			get;
			set;
		}

		public string NewOIDs
		{
			get;
			set;
		}

		public string HisOIDs
		{
			get;
			set;
		}
		...
		public bool UnDoChange(IFeatureClass ifeatureClass_0)
		{
			...
			if (this.CanUndo(ifeatureClass_0))
			{
				...
				IFeatureClass featureClass = ((ifeatureClass_0 as IDataset).Workspace as IFeatureWorkspace).OpenFeatureClass(historyZDFeatureName);
