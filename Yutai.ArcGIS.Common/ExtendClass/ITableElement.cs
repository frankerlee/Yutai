...
namespace Yutai.ArcGIS.Common.ExtendClass
{
    public interface ITableElement
    {
        ...
        /// 内部水平线
        /// </summary>
        bool HasInnerHorizontalLine { get; set; }

        /// <summary>
        /// 内部竖直线
        /// </summary>
        bool HasInnerVerticalLine { get; set; }

        /// <summary>
        /// 左边线
        /// </summary>
        bool HasLeftBoundLine { get; set; }

        /// <summary>
        /// 下边线
        /// </summary>
        bool HasLowerBoundLine { get; set; }

        /// <summary>
        /// 右边线
        /// </summary>
        bool HasRightBoundLine { get; set; }

        /// <summary>
        /// 上边线
        /// </summary>
        bool HasUpperBoundLine { get; set; }
        ...
        /// </summary>
        bool OnlyFirstHorizontalLine { get; set; }

        /// <summary>
        /// 只有内部第一个竖直线。仅当HasInnerVerticalLine为true，该值才起作用
        /// </summary>
        bool OnlyFirstVerticalLine { get; set; }
