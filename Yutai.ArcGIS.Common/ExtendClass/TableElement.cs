...
namespace Yutai.ArcGIS.Common.ExtendClass
{
    ...
    public class TableElement : IBoundsProperties, IClone, IElement, IElementProperties, IElementProperties2,
        IGraphicElement, ITransform2D, IPersistStream, IPersist, IDocumentVersionSupportGEN, ITableElement,
        IGraphicsComposite
    {
        ...
        /// 内部水平线
        /// </summary>
        public bool HasInnerHorizontalLine { get; set; }

        /// <summary>
        /// 内部竖直线
        /// </summary>
        public bool HasInnerVerticalLine { get; set; }

        /// <summary>
        /// 左边线
        /// </summary>
        public bool HasLeftBoundLine { get; set; }

        /// <summary>
        /// 下边线
        /// </summary>
        public bool HasLowerBoundLine { get; set; }

        /// <summary>
        /// 右边线
        /// </summary>
        public bool HasRightBoundLine { get; set; }

        /// <summary>
        /// 上边线
        /// </summary>
        public bool HasUpperBoundLine { get; set; }
        ...
        /// </summary>
        public bool OnlyFirstHorizontalLine { get; set; }

        /// <summary>
        /// 只有内部第一个竖直线。仅当HasInnerVerticalLine为true，该值才起作用
        /// </summary>
        public bool OnlyFirstVerticalLine { get; set; }
                ...
                try
                {
                    ...
                    for (int i = 0; i < this.RowNumber; i++)
                    {
                        for (int j = 0; j < this.ColumnNumber; j++)
                        {
                            ...
                            propertySetClass.SetProperty(string.Format("{0},{1}", i, j),
                                this.FindElement(this.m_pGroupElement as IGroupElement, cellElement));
                        }
                    }
                }
                catch
