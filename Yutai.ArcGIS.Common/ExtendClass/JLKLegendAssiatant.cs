...
namespace Yutai.ArcGIS.Common.ExtendClass
{
    public class JLKLegendAssiatant
    {
        ...
        /// 绘制背景
        /// </summary>
        public bool DrawBackgroup { get; set; }
        ...
        private IElement CreateTextElement(IPoint pt, string des, int size)
        {
            ...
            (textElementClass as ITextElement).Symbol = this.FontStyle((double) size,
                esriTextHorizontalAlignment.esriTHALeft, esriTextVerticalAlignment.esriTVACenter);
        ...
        private IElement CreateTitleElement(IPoint pt)
        {
            ...
            (textElementClass as ITextElement).Symbol = this.FontStyle(20, esriTextHorizontalAlignment.esriTHALeft,
                esriTextVerticalAlignment.esriTVATop);
            return textElementClass;
        }
