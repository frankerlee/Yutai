...
{
    public class FractionTextElement1 : IBoundsProperties, IClone, IElement, IElementProperties, IElementProperties2,
        IGraphicElement, ITransform2D, IFractionTextElement1, IPersistStream, IPersist
    {
        ...
        {
            get { return this.m_pFractionTextSymbol; }
            set
            {
