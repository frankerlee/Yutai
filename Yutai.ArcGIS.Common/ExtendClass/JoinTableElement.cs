...
namespace Yutai.ArcGIS.Common.ExtendClass
{
    ...
    public class JoinTableElement : IBoundsProperties, IClone, IElement, IElementProperties, IElementProperties2,
        IGraphicElement, ITransform2D, IPersistStream, IPersist, IDocumentVersionSupportGEN, IJoinTableElement
    {
        ...
        {
            get { return (this.m_pGroupElement as IElementProperties).AutoTransform; }
            set { (this.m_pGroupElement as IElementProperties).AutoTransform = value; }
        }

        public object CustomProperty
        {
            get { return (this.m_pGroupElement as IElementProperties).CustomProperty; }
            set { (this.m_pGroupElement as IElementProperties).CustomProperty = value; }
        }
        ...
        {
            get { return this.m_pGroupElement.Geometry; }
            set
            {
        ...
        public bool Locked
        {
            get { return this.m_pGroupElement.Locked; }
            set { this.m_pGroupElement.Locked = value; }
        }

        public string Name
        {
            get { return (this.m_pGroupElement as IElementProperties).Name; }
            set { (this.m_pGroupElement as IElementProperties).Name = value; }
        }
        ...
        internal IPropertySet PropertySet
        {
            get
            {
                ...
                for (int i = 0; i < this.m_pTextElementList.Count; i++)
                {
                    if (i != 4)
                    {
                        propertySetClass.SetProperty(string.Concat("TextElement", i.ToString()),
                            this.m_pTextElementList[i]);
                        propertySetClass.SetProperty(string.Concat("TextElementAdd", i.ToString()),
                            this.m_pTextElementAdd[i]);
                    }
                }
                    ...
                    for (int i = 0; i < 9; i++)
                    {
                        ...
                        else
                        {
                            this.m_pTextElementList.Add(
                                propertySet.GetProperty(string.Concat("TextElement", i.ToString())) as ITextElement);
                            this.m_pTextElementAdd.Add(
                                Convert.ToBoolean(propertySet.GetProperty(string.Concat("TextElementAdd", i.ToString()))));
                        }
                    }
                }
        ...
        {
            get { return (this.m_pGroupElement as IElementProperties2).ReferenceScale; }
            set { (this.m_pGroupElement as IElementProperties2).ReferenceScale = value; }
        }

        public string Row1Col1Text { get; set; }

        public string Row1Col2Text { get; set; }

        public string Row1Col3Text { get; set; }

        public string Row2Col1Text { get; set; }

        public string Row2Col3Text { get; set; }

        public string Row3Col1Text { get; set; }

        public string Row3Col2Text { get; set; }

        public string Row3Col3Text { get; set; }

        public ISelectionTracker SelectionTracker
        {
            get { return this.m_pGroupElement.SelectionTracker; }
        }

        public ISpatialReference SpatialReference
        {
            get { return (this.m_pGroupElement as IGraphicElement).SpatialReference; }
            set { (this.m_pGroupElement as IGraphicElement).SpatialReference = value; }
        }
        ...
        public string Type
        {
            get { return (this.m_pGroupElement as IElementProperties).Type; }
            set { (this.m_pGroupElement as IElementProperties).Type = value; }
        }
