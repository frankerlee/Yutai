...
namespace Yutai.ArcGIS.Common.Geodatabase
{
    public class VCTReader : IProgressMessage
    {
        ...
        {
            return WorkspaceOperator.GetFinalName(this.ifeatureWorkspace_0 as IWorkspace,
                esriDatasetType.esriDTFeatureClass, string_9);
        }
        ...
        private void method_12(string string_9, out esriGeometryType esriGeometryType_0,
            out esriFeatureType esriFeatureType_0)
        {
        ...
        private IFeatureClass method_13(string string_9, IFeatureDataset ifeatureDataset_1, double double_8,
            ITextSymbol itextSymbol_0, IFields ifields_0)
        {
            ...
            if ((this.ifeatureWorkspace_0 as IWorkspace).Type != esriWorkspaceType.esriFileSystemWorkspace)
            {
                ...
                IAnnotateLayerPropertiesCollection2 annotateLayerPropertiesCollectionClass =
                    new AnnotateLayerPropertiesCollection() as IAnnotateLayerPropertiesCollection2;
                ...
                ILabelEngineLayerProperties itextSymbol0 =
                ...
                try
                {
                    IFeatureClass featureClass1 = ifeatureWorkspace0.CreateAnnotationClass(string_9, field,
                        instanceCLSID, classExtensionCLSID, featureClassDescription.ShapeFieldName, "",
                        ifeatureDataset_1, null, annotateLayerPropertiesCollectionClass, graphicsLayerScaleClass,
            ...
            else
            {
                ...
                try
                {
                    featureClass2 = (this.ifeatureDataset_0 == null
                        ? this.ifeatureWorkspace_0.CreateFeatureClass(string_9, requiredFields, null, null,
                            esriFeatureType.esriFTSimple, shapeFieldName, "")
                        : this.ifeatureDataset_0.CreateFeatureClass(string_9, requiredFields, null, null,
                            esriFeatureType.esriFTSimple, shapeFieldName, ""));
                }
        ...
        private IFeatureClass method_2(string string_9, esriFeatureType esriFeatureType_0,
            esriGeometryType esriGeometryType_0, IFields ifields_0)
        {
            string str;
            IFeatureClass featureClass;
            ISpatialReference spatialReference;
            ...
            if (esriFeatureType_0 != esriFeatureType.esriFTAnnotation)
            {
                ...
                try
                {
                    featureClass1 = (this.ifeatureDataset_0 == null
                        ? this.ifeatureWorkspace_0.CreateFeatureClass(string_9, requiredFields, null, null,
                            _esriFeatureType, shapeFieldName, "")
                        : this.ifeatureDataset_0.CreateFeatureClass(string_9, requiredFields, null, null,
                            _esriFeatureType, shapeFieldName, ""));
                }
                catch (Exception exception)
            ...
            {
                featureClass = this.method_13(string_9, this.ifeatureDataset_0, this.double_7, new TextSymbol(),
                    ifields_0);
            }
            return featureClass;
        }
                ...
                else
                {
                    ...
                    if (str5 != "100")
                    {
                        ...
                        else if (str5 == "2")
                        {
                            ...
                            (polylineClass as ISegmentCollection).AddSegment(circularArcClass as ISegment, ref value,
                                ref value);
                        }
                        else if (str5 == "3")
                        {
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                if (ringClass != null)
                                                {
                                                    ...
                                                    {
                                                        polygonClass.AddGeometry(ringClass as IGeometry, ref value,
                                                            ref value);
                                                    }
                                                }
                                                ringClass = new Ring();
        ...
        public void Read(string string_9)
        {
            ...
            ISpatialReference spatialReference =
                SpatialReferenctOperator.ConstructCoordinateSystem(this.ifeatureWorkspace_0 as IGeodatabaseRelease);
