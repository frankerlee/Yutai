...
namespace Yutai.ArcGIS.Common.Geodatabase
{
	public class SDEToShapefile : IConvertEvent, IConvertEventEx
	{
        ...
        private static void AddFields(IRow irow_0, IRow irow_1, System.Collections.Generic.List<SDEToShapefile.FieldMap> list_1)
        {
            try
            {
                ...
                for (int i = 0; i < fields2.FieldCount; i++)
                {
                    ...
                    if (field.Type != esriFieldType.esriFieldTypeGeometry && field.Type != esriFieldType.esriFieldTypeOID && field.Editable)
                    {
                        int j = 0;
        ...
        private static void AddFields(IRowBuffer irowBuffer_0, IRow irow_0, System.Collections.Generic.List<SDEToShapefile.FieldMap> list_1)
        {
		...
		private void method_1(IFeatureClass ifeatureClass_0, IWorkspace iworkspace_0)
		{
			...
			try
			{
				IFeatureClass featureClass = (iworkspace_0 as IFeatureWorkspace).CreateFeatureClass(str, field, null, null, esriFeatureType.esriFTSimple, ifeatureClass_0.ShapeFieldName, "");
				...
				while (row != null)
				{
					...
					try
					{
						...
						else
						{
							...
							{
								IGeometry geometry1 = ((row as IAnnotationFeature).Annotation as ITextElement as IElement).Geometry;
		...
		public event SetFeatureClassMaxValueHandler SetFeatureClassMaxValueEvent
		{
			add
			{
				...
				do
				{
					...
					SetFeatureClassMaxValueHandler setFeatureClassMaxValueHandler1 = (SetFeatureClassMaxValueHandler)Delegate.Combine(setFeatureClassMaxValueHandler, value);
					setFeatureClassMaxValueHandler0 = Interlocked.CompareExchange<SetFeatureClassMaxValueHandler>(ref this.setFeatureClassMaxValueHandler_0, setFeatureClassMaxValueHandler1, setFeatureClassMaxValueHandler);
				}
			...
			remove
			{
				...
				{
					setFeatureClassMaxValueHandler = setFeatureClassMaxValueHandler0;
					SetFeatureClassMaxValueHandler setFeatureClassMaxValueHandler1 = (SetFeatureClassMaxValueHandler)Delegate.Remove(setFeatureClassMaxValueHandler, value);
					setFeatureClassMaxValueHandler0 = Interlocked.CompareExchange<SetFeatureClassMaxValueHandler>(ref this.setFeatureClassMaxValueHandler_0, setFeatureClassMaxValueHandler1, setFeatureClassMaxValueHandler);
				}
				while ((object)setFeatureClassMaxValueHandler0 != (object)setFeatureClassMaxValueHandler);
			}
		...
		public event SetFeatureClassMinValueHandler SetFeatureClassMinValueEvent
		{
			add
			{
				...
				do
				{
					...
					SetFeatureClassMinValueHandler setFeatureClassMinValueHandler1 = (SetFeatureClassMinValueHandler)Delegate.Combine(setFeatureClassMinValueHandler, value);
					setFeatureClassMinValueHandler0 = Interlocked.CompareExchange<SetFeatureClassMinValueHandler>(ref this.setFeatureClassMinValueHandler_0, setFeatureClassMinValueHandler1, setFeatureClassMinValueHandler);
				}
			...
			remove
			{
				...
				{
					setFeatureClassMinValueHandler = setFeatureClassMinValueHandler0;
					SetFeatureClassMinValueHandler setFeatureClassMinValueHandler1 = (SetFeatureClassMinValueHandler)Delegate.Remove(setFeatureClassMinValueHandler, value);
					setFeatureClassMinValueHandler0 = Interlocked.CompareExchange<SetFeatureClassMinValueHandler>(ref this.setFeatureClassMinValueHandler_0, setFeatureClassMinValueHandler1, setFeatureClassMinValueHandler);
				}
				while ((object)setFeatureClassMinValueHandler0 != (object)setFeatureClassMinValueHandler);
			}
		...
		public event SetFeatureClassPositionHandler SetFeatureClassPositionEvent
		{
			add
			{
				...
				do
				{
					...
					SetFeatureClassPositionHandler setFeatureClassPositionHandler1 = (SetFeatureClassPositionHandler)Delegate.Combine(setFeatureClassPositionHandler, value);
					setFeatureClassPositionHandler0 = Interlocked.CompareExchange<SetFeatureClassPositionHandler>(ref this.setFeatureClassPositionHandler_0, setFeatureClassPositionHandler1, setFeatureClassPositionHandler);
				}
			...
			remove
			{
				...
				{
					setFeatureClassPositionHandler = setFeatureClassPositionHandler0;
					SetFeatureClassPositionHandler setFeatureClassPositionHandler1 = (SetFeatureClassPositionHandler)Delegate.Remove(setFeatureClassPositionHandler, value);
					setFeatureClassPositionHandler0 = Interlocked.CompareExchange<SetFeatureClassPositionHandler>(ref this.setFeatureClassPositionHandler_0, setFeatureClassPositionHandler1, setFeatureClassPositionHandler);
				}
				while ((object)setFeatureClassPositionHandler0 != (object)setFeatureClassPositionHandler);
			}
		...
		public event SetHandleFeatureInfoHandler SetHandleFeatureInfoEvent
		{
			add
			{
				...
				do
				{
					...
					SetHandleFeatureInfoHandler setHandleFeatureInfoHandler1 = (SetHandleFeatureInfoHandler)Delegate.Combine(setHandleFeatureInfoHandler, value);
					setHandleFeatureInfoHandler0 = Interlocked.CompareExchange<SetHandleFeatureInfoHandler>(ref this.setHandleFeatureInfoHandler_0, setHandleFeatureInfoHandler1, setHandleFeatureInfoHandler);
				}
			...
			remove
			{
				...
				{
					setHandleFeatureInfoHandler = setHandleFeatureInfoHandler0;
					SetHandleFeatureInfoHandler setHandleFeatureInfoHandler1 = (SetHandleFeatureInfoHandler)Delegate.Remove(setHandleFeatureInfoHandler, value);
					setHandleFeatureInfoHandler0 = Interlocked.CompareExchange<SetHandleFeatureInfoHandler>(ref this.setHandleFeatureInfoHandler_0, setHandleFeatureInfoHandler1, setHandleFeatureInfoHandler);
				}
				while ((object)setHandleFeatureInfoHandler0 != (object)setHandleFeatureInfoHandler);
			}
