...
namespace Yutai.ArcGIS.Common.Geodatabase
{
	public class MiTab2DataConvert : IFeatureProgress_Event, IFeatureDataConverter, IFeatureDataConverter2
	{
							...
							while (num != -1)
							{
								...
								switch (num1)
								{
									...
									case 3:
									{
										...
										{
											featureClass = this.method_1(string0, num1, intPtr, ifeatureWorkspace_0, out flag1);
											if (flag1)
											{
												flag = false;
												return flag;
									...
									case 4:
									{
										...
										{
											featureClass4 = this.method_1(string0, num1, intPtr, ifeatureWorkspace_0, out flag1);
											if (flag1)
											{
												flag = false;
												return flag;
									...
									case 6:
									{
										...
										{
											featureClass2 = this.method_1(string0, num1, intPtr, ifeatureWorkspace_0, out flag1);
											if (flag1)
											{
												flag = false;
												return flag;
									...
									case 7:
									{
										...
										{
											featureClass3 = this.method_1(string0, num1, intPtr, ifeatureWorkspace_0, out flag1);
											if (flag1)
											{
												flag = false;
												return flag;
									...
									case 10:
									{
										...
										{
											featureClass1 = this.method_1(string0, num1, intPtr, ifeatureWorkspace_0, out flag1);
											if (flag1)
											{
												flag = false;
												return flag;
		...
		private string method_0(IWorkspace iworkspace_0, string string_0)
		{
			...
			if ((iworkspace_0.Type == esriWorkspaceType.esriLocalDatabaseWorkspace ? false : iworkspace_0.Type != esriWorkspaceType.esriRemoteDatabaseWorkspace))
			{
		...
		private IFeatureClass method_1(string string_0, int int_0, IntPtr intptr_0, IFeatureWorkspace ifeatureWorkspace_0, out bool bool_0)
		{
			...
			try
			{
				...
				if (this.ispatialReference_0 == null)
				{
					...
					else
					{
						...
						try
						{
							this.ispatialReference_0 = (new SpatialReferenceEnvironment()).CreateESRISpatialReferenceFromPRJFile(str1);
						}
						catch
						{
							this.ispatialReference_0 = geometryDef.SpatialReference;
					...
					SpatialReferenctOperator.ChangeCoordinateSystem(ifeatureWorkspace_0 as IGeodatabaseRelease, this.ispatialReference_0, false);
					num = num - 10;
					num1 = num1 + 10;
					num2 = num2 - 10;
					num3 = num3 + 10;
				...
				switch (int_0)
				{
					...
					case 3:
					{
						...
						fileNameWithoutExtension = this.method_0(ifeatureWorkspace_0 as IWorkspace, fileNameWithoutExtension);
						geometryDef.GeometryType_2 = esriGeometryType.esriGeometryPoint;
						fieldEdit.GeometryDef_2 = geometryDef;
						featureClass1 = ifeatureWorkspace_0.CreateFeatureClass(fileNameWithoutExtension, field, null, null, esriFeatureType.esriFTSimple, shapeFieldName, "");
						break;
					}
					case 4:
					{
