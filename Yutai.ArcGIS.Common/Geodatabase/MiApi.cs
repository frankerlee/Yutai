...
namespace Yutai.ArcGIS.Common.Geodatabase
{
	public class MiApi
	{
		...
		public static extern IntPtr mitab_c_add_field(IntPtr intptr_0, string string_0, int int_0, int int_1, int int_2, int int_3, int int_4);

		[DllImport("mitab.dll", CharSet=CharSet.None, ExactSpelling=false)]
		public static extern void mitab_c_close(IntPtr intptr_0);

		[DllImport("mitab.dll", CharSet=CharSet.None, ExactSpelling=false)]
		public static extern IntPtr mitab_c_create(string string_0, string string_1, string string_2, double double_0, double double_1, double double_2, double double_3);
		...
		[DllImport("mitab.dll", CharSet=CharSet.None, EntryPoint="mitab_c_get_extended_mif_coordsys", ExactSpelling=false)]
		...
		[DllImport("mitab.dll", CharSet=CharSet.None, EntryPoint="mitab_c_get_field_as_string", ExactSpelling=false)]
		...
		[DllImport("mitab.dll", CharSet=CharSet.None, ExactSpelling=false)]
		public static extern void mitab_c_set_arc(IntPtr intptr_0, double double_0, double double_1, double double_2, double double_3, double double_4, double double_5);
		...
		[DllImport("mitab.dll", CharSet=CharSet.None, ExactSpelling=false)]
		public static extern void mitab_c_set_points(IntPtr intptr_0, int int_0, int int_1, ref double double_0, ref double double_1);
		...
		[DllImport("mitab.dll", CharSet=CharSet.None, ExactSpelling=false)]
		public static extern void mitab_c_set_text_display(IntPtr intptr_0, double double_0, double double_1, double double_2, int int_0, int int_1, int int_2, int int_3, int int_4);
