...
namespace Yutai.ArcGIS.Common.Geodatabase
{
    public class CASSReader : ESRI.ArcGIS.Geodatabase.IFeatureProgress_Event
    {
        ...
        public bool IsInFeatureDataset { get; set; }
        ...
        private IFeatureClass method_1(string string_3, double double_1, ITextSymbol itextSymbol_0)
        {
            ...
            spatialReference.SetDomain(this.ienvelope_0.XMin, this.ienvelope_0.XMax, this.ienvelope_0.YMin,
                this.ienvelope_0.YMax);
            SpatialReferenctOperator.ChangeCoordinateSystem(this.ifeatureWorkspace_0 as IGeodatabaseRelease,
            ...
            IFeatureClass featureClass = null;
            featureClass = ifeatureWorkspace0.CreateAnnotationClass(string_3, field, instanceCLSID, classExtensionCLSID,
                featureClassDescription.ShapeFieldName, "", this.FeatureDataset, null, null, graphicsLayerScaleClass,
                symbolCollectionClass, true);
            return featureClass;
        }

        private void method_10(StreamReader streamReader_0, IFeatureClass ifeatureClass_9, string string_3,
            string string_4)
        {
        ...
        private void method_11(StreamReader streamReader_0, IFeatureClass ifeatureClass_9, string string_3,
            string string_4)
        {
            string str;
        ...
        private void method_12(StreamReader streamReader_0, IFeatureClass ifeatureClass_9, string string_3,
            string string_4)
        {
            string str;
            string str1;
                    ...
                    while (streamReader_0.Peek() >= 0)
                    {
                        ...
                        if (str4 == "C" && pathClass.PointCount > 2)
                        {
                            ...
                            try
                            {
                                if (this.ifeatureClass_2 == null)
                                {
                                    this.ifeatureClass_2 = this.method_3(string.Concat(this.string_2, "_Polygong"),
                                        "POLYGON");
                                }
                                ...
                                IPolygon polygonClass = new Polygon() as IPolygon;
                                (polygonClass as ISegmentCollection).AddSegmentCollection(
                                    pathClass as ISegmentCollection);
                                if (!(polygonClass as ITopologicalOperator).IsSimple)
                                {
                                    (polygonClass as ITopologicalOperator).Simplify();
                                }
        ...
        private void method_14(StreamReader streamReader_0, IFeatureClass ifeatureClass_9, string string_3,
            string string_4)
        {
            while (streamReader_0.Peek() >= 0)
            {
        ...
        private void method_16(StreamReader streamReader_0, IFeatureClass ifeatureClass_9, string string_3,
            ...
            while (streamReader_0.Peek() >= 0)
            {
                ...
                if (num == 4)
                {
                        ...
                        do
                        {
                            ...
                            if ((str == "E" || str == "C" ? true : str == "e"))
                            {
                                if (pathClass.PointCount > 1)
                                {
                                    ...
                                    (polylineClass as IGeometryCollection).AddGeometry(pathClass as IGeometry, ref value,
                                        ref value);
                                }
                                pathClass = new ESRI.ArcGIS.Geometry.Path();
                            }
                    ...
                    else
                    {
                        ...
                        {
                            this.ifeatureClass_4 = this.method_4(string.Concat(this.string_2, "_JZXLINE"),
                            ...
                            if ((str == "E" || str == "C" ? true : str == "e"))
                            {
                                if (pathClass.PointCount > 1)
                                {
                                    if (str == "C")
                                    {
                                        ...
                                        {
                                            this.ifeatureClass_5 =
                                                this.method_4(string.Concat(this.string_2, "_JZXPolygong"),
                ...
                if (streamReader_0.Peek() >= 0)
                {
                    ...
                    else
                    {
                        ...
                        if (str2 == "POINT")
                        {
                            ...
                            !(str2 == "LINE" || str2 == "ARC" || str2 == "PLINE" || str2 == "SPLINE"
                                ? false
                                : !(str2 == "CIRCLE")))
                        {
        ...
        private IFeatureClass method_2(string string_3)
        {
            ...
            else
            {
                ...
                int num =
                    requiredFields.FindField((featureClassDescriptionClass as IFeatureClassDescription).ShapeFieldName);
                ...
                requiredFields.AddField(fieldClass);
                featureClass1 = this.ifeatureWorkspace_0.CreateFeatureClass(string_3, requiredFields, null, null,
        ...
        private IFeatureClass method_3(string string_3, string string_4)
        {
            ...
            {
                string name = (this.ifeatureWorkspace_0 as ISQLSyntax).QualifyTableName(this.string_1, this.string_0,
                    string_3);
            ...
            else
            {
                ...
                else if (string_4 == "LINE" || string_4 == "ARC" || string_4 == "PLINE" || string_4 == "SPLINE" ||
                         string_4 == "CIRCLE")
                {
                ...
                try
                {
                    if (this.ifeatureDataset_0 != null)
                    {
                        featureClass = this.ifeatureDataset_0.CreateFeatureClass(string_3, fieldsEdit, null, null,
                            featureType, "Shape", "");
                    }
                    else
                    {
                        featureClass = this.ifeatureWorkspace_0.CreateFeatureClass(string_3, fieldsEdit, null, null,
                            featureType, "Shape", "");
                    }
                }
        ...
        private IFeatureClass method_4(string string_3, esriGeometryType esriGeometryType_0)
        {
            ...
            requiredFields.AddField(fieldClass);
            field.GeometryDef_2 = geometryDef;
            featureClass = this.ifeatureWorkspace_0.CreateFeatureClass(string_3, requiredFields, null, null,
                esriFeatureType.esriFTSimple, "Shape", "");
            return featureClass;
        }
        ...
        private void method_6(StreamReader streamReader_0, IFeatureClass ifeatureClass_9, string string_3,
            string string_4)
        {
        ...
        private void method_8(StreamReader streamReader_0, IFeatureClass ifeatureClass_9, string string_3,
            string string_4)
        {
            string str;
            int string3 = ifeatureClass_9.Fields.FindField("Layer");
        ...
        private void method_9(StreamReader streamReader_0, IFeatureClass ifeatureClass_9, string string_3,
            string string_4)
        {
            object value = Missing.Value;
            int string3 = ifeatureClass_9.Fields.FindField("Layer");
        ...
        public void Read(string string_3)
        {
            ...
            if (File.Exists(string_3))
            {
                ...
                {
                    this.ifeatureDataset_0 = this.ifeatureWorkspace_0.CreateFeatureDataset(this.string_2,
                        new UnknownCoordinateSystem() as ISpatialReference);
                }
