...
namespace Yutai.ArcGIS.Common.Data
{
    public abstract class BaseConnection : IDisposable, IConnection
    {
        ...
        public abstract string ADOConnectionString { get; }
        ...
        public abstract DbCommandBuilder CommandBuilder { get; }
        ...
        public abstract IDbDataAdapter DataAdapter { get; }

        public abstract DataProviderType DataProviderType { get; }
        ...
        public static BaseConnection ShowConnectionDialog(DataProviderType dataProviderType_0, string string_0)
        {
            ...
            switch (dataProviderType_0)
            {
                case DataProviderType.OleDb:
                {
                    ...
                    dataConnectionDialog.SetSelectedDataProvider(DataSource.AccessDataSource,
                        DataProvider.OleDBDataProvider);
                ...
                case DataProviderType.Oracle:
                {
                    ...
                    dataConnectionDialog.SetSelectedDataProvider(DataSource.OracleDataSource,
