...
namespace Yutai.ArcGIS.Common.Data
{
    public class DBAccess
    {
        ...
        public OleDbConnection Connection
        {
            ...
            set { this.oleDbConnection_0 = value; }
        }
        ...
        public bool OpenAccessDB(string string_1, string string_2, string string_3)
        {
            ...
            {
                "Provider=Microsoft.Jet.OleDb.4.0;User ID=", string_1, ";Data Source=", string_3, ";Password=",
                string_2
            };
        ...
        {
            string[] string1 = new string[]
                {"Provider=MSDAORA;User ID=", string_1, ";Data Source=", string_3, ";Password=", string_2};
            this.string_0 = string.Concat(string1);
            return this.Open();
        }
        ...
        public bool WriteOracleLOB(string string_1, string string_2)
        {
            ...
            string[] string2 = new string[]
                {"insert  into GRD(SZTFH,SZHH,GCXX,objectid) values('", string_2, "','0','temp',", num.ToString(), ")"};
