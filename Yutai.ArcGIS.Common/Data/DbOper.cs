...
namespace Yutai.ArcGIS.Common.Data
{
	public class DbOper
	{
		...
		public static void DbBackup(string string_0, string string_1, string string_2, string string_3, string string_4, string string_5, string string_6)
		{
		...
		public static bool DbBackupEx(string string_0, string string_1, string string_2, string string_3, string string_4, string string_5, string string_6)
		{
			bool flag;
			bool flag1 = false;
			Backup backupClass = new Backup();
		...
		public static bool DbRestoreEx(string string_0, string string_1, string string_2, string string_3, string string_4)
		{
			bool flag = false;
			string columnString = "";
			Restore restoreClass = new Restore();
