...
namespace Yutai.ArcGIS.Common.Data
{
    internal sealed class GcSqlConnection : BaseConnection
    {
        ...
        {
            get { return this.sqlConnection_0; }
        }
        ...
        public GcSqlConnection(string string_0, string string_1, string string_2, string string_3)
            : this(
                string.Concat(new string[]
                {
                    "Data Source=", string_0, ";Initial Catalog=", string_1, ";Persist Security Info=True;User ID=",
                    string_2, ";Password=", string_3
                }))
        {
        }
