    ...
    public partial class frmDatabaseBack : Form
    {
        ...
        private void bAddUser_Click(object sender, EventArgs e)
        {
            ...
            else if ((str2 == null ? false : !(str2 == "")))
            {
                ...
                {
                    "Provider=SQLOLEDB;Data Source=", text, ";Initial Catalog=", text1, ";User Id=", str, ";Password=",
                    str1
                };
                ...
                try
                {
                    try
                    {
                        ...
                        {
                            "BEGIN exec sp_addlogin N'", str2, "', '", text2, "', N'", text1,
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            {
                string[] strArrays = new string[]
                    {"Provider=SQLOLEDB;Data Source=", text, ";User Id=", str, ";Password=", str1};
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else if (!(str3 == null ? false : !(str3 == "")))
            {
                ...
                !(str3.Substring(str3.Length - 1, 1) == "\\"
                    ? false
                    : !(str3.Substring(str3.Length - 4, 4).ToLower() != ".bak")))
            {
                MessageBox.Show("必须输入完整并且正确的备份文件名!");
            }
            else if (MessageBox.Show("你确认进行数据库备份吗?", "提示信息", MessageBoxButtons.YesNo, MessageBoxIcon.Question) ==
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (!this.radioButton3.Checked)
            {
                    ...
                    : !(str5.Substring(str5.Length - 4, 4).ToLower() != ".ldf")))
                {
                    ...
                    if (MessageBox.Show("你确认进行数据库附加吗?", "提示信息", MessageBoxButtons.YesNo, MessageBoxIcon.Question) ==
                        System.Windows.Forms.DialogResult.Yes)
                    {
                        ...
                        else
                        {
                            ...
                            if (str3.Trim().ToUpper() == "SDE")
                            {
                                ...
                                try
                                {
                                    ...
                                    {
                                        oleDbDataAccessLayer.Open();
                                        oleDbDataAccessLayer.ExecuteNonQuery(
                                            "BEGIN exec sp_addlogin  'sde','go','sde' END ", new object[0]);
                                ...
                                try
                                {
                                    try
                                    {
                                        oleDbDataAccessLayer.Open();
                                        oleDbDataAccessLayer.ExecuteNonQuery(
                                            "BEGIN exec sp_change_users_login 'update_one','sde','sde'  END ",
                                            new object[0]);
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            else if ((str3 == null ? false : !(str3 == "")))
            {
                string[] strArrays = new string[]
                {
                    "Provider=SQLOLEDB;Data Source=", text, ";Initial Catalog=", str2, ";User Id=", str, ";Password=",
                    str1
                };
                OleDbDataAccessLayer oleDbDataAccessLayer = new OleDbDataAccessLayer(string.Concat(strArrays));
                try
                {
                    try
                    {
                        oleDbDataAccessLayer.Open();
                        strArrays = new string[]
                            {"BEGIN exec  sp_revokedbaccess N'", str3, "'  exec sp_droplogin N'", str3, "' END "};
                        string str4 = string.Concat(strArrays);
                        oleDbDataAccessLayer.ExecuteNonQuery(str4, new object[0]);
        ...
        private bool method_0(string string_0, string string_1, string string_2, string string_3)
        {
            ...
            try
            {
                ...
                {
                    "EXEC sp_attach_db @dbname = '", string_1, "', @filename1 = '", string_2, "',@filename2='",
                    string_3, "'"
                };
