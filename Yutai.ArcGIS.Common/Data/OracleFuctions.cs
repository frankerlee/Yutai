...
namespace Yutai.ArcGIS.Common.Data
{
    public class OracleFuctions
    {
        ...
        public static void CallCreateUserParFileConntion(ref ArrayList arrayList_0, string string_0, string string_1,
        ...
        public static void ConnectTest(string string_0, string string_1, string string_2)
        {
            ...
            else if ((string_0 == null ? false : !(string_0.Trim() == "")))
            {
                ...
                {
                    "Provider=\"OraOLEDB.Oracle\";User ID=", string_1, ";Data Source=", string_0, ";Password=",
                    string_2
                };
        ...
        public static void DeleteTableSpaceFile(string string_0, string string_1, string string_2, string string_3,
            string string_4)
        {
            int i;
            if (!(string_0 == null ? false : !(string_0.Trim() == "")))
            ...
            else if ((string_4 == null ? false : !(string_4.Trim() == "")))
            {
                ...
                startupPath = Application.StartupPath;
                startupPath = (startupPath.Substring(startupPath.Length - 1, 1) != "\\"
                    ? string.Concat(startupPath, "\\dropTableSpace.par")
                    : string.Concat(startupPath, "dropTableSpace.par"));
                ClsReadWriteTxt clsReadWriteTxt = new ClsReadWriteTxt();
                clsReadWriteTxt.DeleteTextFile(startupPath);
                clsReadWriteTxt.CreateTextFile(startupPath);
                ...
                str = Application.StartupPath;
                str = (str.Substring(str.Length - 1, 1) != "\\"
                    ? string.Concat(str, "\\dropTableSpace.bat")
                    : string.Concat(str, "dropTableSpace.bat"));
                clsReadWriteTxt = new ClsReadWriteTxt();
                clsReadWriteTxt.DeleteTextFile(str);
                clsReadWriteTxt.CreateTextFile(str);
        ...
        public static void ExportUsers(string string_0, string string_1, string string_2, string string_3,
            string string_4)
        {
            if (!(string_0 == null ? false : !(string_0.Trim() == "")))
            {
            ...
            else if ((string_3 == null ? false : !(string_3.Trim() == "")))
            {
                ...
                startupPath = Application.StartupPath;
                startupPath = (startupPath.Substring(startupPath.Length - 1, 1) != "\\"
                    ? string.Concat(startupPath, "\\Exp_User", string_0, ".bat")
                    : string.Concat(startupPath, "Exp_User", string_0, ".bat"));
                ClsReadWriteTxt clsReadWriteTxt = new ClsReadWriteTxt();
                clsReadWriteTxt.DeleteTextFile(startupPath);
                clsReadWriteTxt.CreateTextFile(startupPath);
                ...
                string[] string0 = new string[]
                {
                    "Exp ", string_0, "/", string_1, "@", string_4, "  file=", string_2, " Full=N  owner=", string_3,
                    " Rows=Y;"
                };
                arrayLists.Add(string.Concat(string0));
            ...
            string string_4, string string_5)
        {
            ...
            else if ((string_5 == null ? false : !(string_5.Trim() == "")))
            {
                ...
                string[] string0 = new string[]
                {
                    "imp ", string_0, "/", string_1, "@", string_2, "  file=", string_3, " Full=N  FromUser=", string_4,
                    " ToUser=", string_5, " Rows=Y Compile=Y;"
                };
                arrayLists.Add(string.Concat(string0));
                for (int i = 0; i < arrayLists.Count; i++)
                {
