...
namespace Yutai.ArcGIS.Common.Data
{
    public class SQlDBManage
    {
        ...
        public bool BackUpDB(string string_3, string string_4, string string_5, string string_6)
        {
            ...
            try
            {
                try
                {
                    ...
                    {
                        "BACKUP DATABASE ", string_4, " to disk='", string_6, "'WITH  NOINIT ,  NOUNLOAD ,  NAME = N'",
                        string_5, "',  NOSKIP ,  STATS = 10,  NOFORMAT "
                    };
        ...
        public bool restoreDB2(string string_3, string string_4)
        {
            ...
            {
                "provider=sqloledb.1;Data Source=", this.ServerName, ";user id=", this.UserName, ";pwd=", this.Password
            };
            ...
            try
            {
                try
                {
                    ...
                    {
                        "RESTORE DATABASE ", string_3, " from disk='", string_4, "' with RECOVERY, MOVE '", str,
                        "' TO '", str2, "', MOVE '", str1, "' TO '", str3, "'"
                    };
