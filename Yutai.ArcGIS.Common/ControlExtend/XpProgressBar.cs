...
namespace Yutai.ArcGIS.Common.ControlExtend
{
    public class XpProgressBar : Control
    {
        ...
        {
            graphics_0.FillRectangle(this.linearGradientBrush_0, 4 + (int_3*(this.byte_0 + this.byte_1)),
                this.rectangle_1.Y + 1, this.byte_1, this.rectangle_1.Height);
            graphics_0.FillRectangle(this.linearGradientBrush_1, 4 + (int_3*(this.byte_0 + this.byte_1)),
                this.rectangle_2.Y + 1, (int) this.byte_1, this.rectangle_2.Height - 1);
        }
        ...
        private void method_5()
        {
            ...
            switch (this.gradientMode_0)
            {
                case GradientMode.Vertical:
                    ...
                    this.linearGradientBrush_0 = new LinearGradientBrush(this.rectangle_1, this.color_0, this.color_1,
                        LinearGradientMode.Vertical);
                    this.rectangle_2 = new Rectangle(-100, -100, 1, 1);
                    this.linearGradientBrush_1 = new LinearGradientBrush(this.rectangle_2, this.color_1, this.color_0,
                ...
                case GradientMode.VerticalCenter:
                    ...
                    this.linearGradientBrush_0 = new LinearGradientBrush(this.rectangle_1, this.color_0, this.color_1,
                        LinearGradientMode.Vertical);
                    this.rectangle_2 = new Rectangle(0, this.rectangle_1.Bottom - 1, this.byte_1,
                        (base.Height - this.rectangle_1.Height) - 4);
                    this.linearGradientBrush_1 = new LinearGradientBrush(this.rectangle_2, this.color_1, this.color_0,
                        LinearGradientMode.Vertical);
                    break;
                ...
                case GradientMode.Horizontal:
                    this.rectangle_1 = new Rectangle(0, 3, this.byte_1, base.Height - 7);
                    this.linearGradientBrush_0 = new LinearGradientBrush(base.ClientRectangle, this.color_0,
                        this.color_1, LinearGradientMode.Horizontal);
                    this.rectangle_2 = new Rectangle(-100, -100, 1, 1);
                    this.linearGradientBrush_1 = new LinearGradientBrush(this.rectangle_2, Color.Red, Color.Red,
                        LinearGradientMode.Horizontal);
                    break;
                ...
                case GradientMode.Diagonal:
                    this.rectangle_1 = new Rectangle(0, 3, this.byte_1, base.Height - 7);
                    this.linearGradientBrush_0 = new LinearGradientBrush(base.ClientRectangle, this.color_0,
                        this.color_1, LinearGradientMode.ForwardDiagonal);
                    this.rectangle_2 = new Rectangle(-100, -100, 1, 1);
                    this.linearGradientBrush_1 = new LinearGradientBrush(this.rectangle_2, Color.Red, Color.Red,
                        LinearGradientMode.Horizontal);
                    break;
            ...
            this.rectangle_0 = new Rectangle(base.ClientRectangle.X + 2, base.ClientRectangle.Y + 2,
                base.ClientRectangle.Width - 4, base.ClientRectangle.Height - 4);
            this.rectangle_3 = new Rectangle(base.ClientRectangle.X, base.ClientRectangle.Y,
                base.ClientRectangle.Width - 1, base.ClientRectangle.Height - 1);
            this.rectangle_4 = new Rectangle(base.ClientRectangle.X + 1, base.ClientRectangle.Y + 1,
        ...
        protected override void OnPaint(PaintEventArgs paintEventArgs_0)
        {
            if (!base.IsDisposed)
            {
                ...
                paintEventArgs_0.Graphics.DrawImage(image, paintEventArgs_0.ClipRectangle.X,
                    paintEventArgs_0.ClipRectangle.Y, paintEventArgs_0.ClipRectangle, GraphicsUnit.Pixel);
                image.Dispose();
                graphics2.Dispose();
            }
        }
        ...
        [RefreshProperties(RefreshProperties.Repaint),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), DefaultValue(false),
         Category("Xp ProgressBar"), Description("Set to TRUE to reset all colors like the Windows XP Progress Bar ")]
        ...
        {
            get { return this.gradientMode_0; }
            set
            {
        ...
        [Category("Xp ProgressBar"), Description("The Current Position of the Progress Bar"),
         RefreshProperties(RefreshProperties.Repaint)]
        public int Position
        {
        ...
        [Category("Xp ProgressBar"), RefreshProperties(RefreshProperties.Repaint),
        ...
        [Description("The Min Position of the Progress Bar"), RefreshProperties(RefreshProperties.Repaint),
        ...
        [Description("The number of Pixels between two Steeps in Progress Bar"), DefaultValue((byte) 2),
         Category("Xp ProgressBar")]
        public byte SteepDistance
        {
            get { return this.byte_0; }
            set
            {
                if (value >= 0)
                {
        ...
        [Category("Xp ProgressBar"), Description("The number of Pixels of the Steeps in Progress Bar"),
         DefaultValue((byte) 6)]
        public byte SteepWidth
        {
            get { return this.byte_1; }
            set
            {
                if (value > 0)
                {
        ...
        [DefaultValue((byte) 150), Description("Set the Alpha Channel of the Text shadow in the Progress Bar"),
         Category("Xp ProgressBar")]
        public byte TextShadowAlpha
        {
            get { return this.byte_2; }
            set
            {
