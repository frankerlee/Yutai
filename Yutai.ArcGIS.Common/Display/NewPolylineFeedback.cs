...
namespace Yutai.ArcGIS.Common.Display
{
	public class NewPolylineFeedback : IOperation, INewLineFeedback, IDisplayFeedback, INewPolylineFeedback
	{
		...
		public esriLineConstraints Constraint
		{
			get
			{
				return this.esriLineConstraints_0;
			}
			set
			{
				this.esriLineConstraints_0 = value;
			}
		}
		...
		public bool HitTest(IPoint ipoint_1, double double_0, out IPoint ipoint_2)
		{
			...
			int num1 = -1;
			int num2 = -1;
			if (!(this.ipointCollection_0.PointCount <= 0 ? true : !ipointCollection0.HitTest(ipoint_1, double_0, esriGeometryHitPartType.esriGeometryPartVertex, ipoint_2, ref num, ref num1, ref num2, ref flag1)))
			{
				flag = true;
			}
			else if ((this.isegmentCollection_0.SegmentCount <= 0 ? true : !(this.isegmentCollection_0 as IHitTest).HitTest(ipoint_1, double_0, esriGeometryHitPartType.esriGeometryPartVertex, ipoint_2, ref num, ref num1, ref num2, ref flag1)))
			{
		...
		private void method_1()
		{
			...
			else if (this.enumLineType_0 == enumLineType.LTTangentCircularArc)
			{
				...
				if (pointCount != 1)
				{
					...
					if (this.ipoint_0 != null)
					{
						circularArc = this.method_8((this.ipointCollection_0 as ISegmentCollection).Segment[0], this.ipoint_0);
						polylineClass.AddSegment(circularArc as ISegment, ref value, ref value);
						this.isymbol_0.Draw(polylineClass as IGeometry);
					}
				}
		...
		public IPolyline SquareAndFinish(ISpatialReference ispatialReference_0)
		{
			...
			if (this.CanSquareAndFinish)
			{
				...
				IGeometry geometry = (polylineClass as ITopologicalOperator).Intersect(polylineClass1, esriGeometryDimension.esriGeometry0Dimension);
				IPoint point1 = null;
