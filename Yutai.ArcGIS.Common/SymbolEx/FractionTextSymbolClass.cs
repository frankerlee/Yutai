...
namespace Yutai.ArcGIS.Common.SymbolEx
{
    ...
    public class FractionTextSymbolClass : ISymbol, ITextSymbol, IDisplayName, IClone, IPersistStream, IPersist,
        IPersistVariant, ISymbolRotation, IMapLevel, ITextParserSupport, IMask, IQueryGeometry, IMarginProperties,
        ITextDrawSupport, ICharacterOrientation, IWordBoundaries, IPropertySupport, IDocumentVersionSupportGEN,
        IFractionTextSymbol
    {
        ...
        {
            get { return (this.m_DenominatorTextSymbol as IFormattedTextSymbol).Background; }
            set { }
        }
        ...
        {
            get { return esriTextCase.esriTCAllCaps; }
            set { }
        }
        ...
        {
            get { return esriTextDirection.esriTDHorizontal; }
            set { }
        }
        ...
        {
            get { return "FractionTextSymbolClass"; }
        }
        ...
        {
            get { return (this.m_DenominatorTextSymbol as IFormattedTextSymbol).FillSymbol; }
            set { }
        }
        ...
        {
            get { return esriTextPosition.esriTPNormal; }
            set { }
        }
        ...
        internal IPropertySet PropertySet
        {
            ...
            set
            {
                ...
                this.m_HorizontalAlignment =
                    (esriTextHorizontalAlignment) propertySet.GetProperty("HorizontalAlignment");
        ...
        protected object State
        {
            ...
            set
            {
                ...
                this.m_HorizontalAlignment =
                    (esriTextHorizontalAlignment) propertySetClass.GetProperty("HorizontalAlignment");
        ...
        {
            get { return (this.m_DenominatorTextSymbol as ISimpleTextSymbol).TextPath; }
            set { }
        }
            ...
            IGeometry drawGeometry, IEnvelope envelope)
        {
            try
            {
                (this.m_NumeratorTextSymbol as IQueryGeometry).QueryEnvelope(hDC, displayTransform, drawGeometry,
                    envelope);
                return;
            }
            catch
        ...
        object ESRI.ArcGIS.Display.ITextDrawSupport.GetDrawPoints(int hDC, ITransformation pTransform,
            IGeometry pGeometry)
        {
            object obj;
            obj = (this.m_DenominatorTextSymbol != null
                ? (this.m_DenominatorTextSymbol as ITextDrawSupport).GetDrawPoints(hDC, pTransform, pGeometry)
                : null);
            return obj;
        }

        void ESRI.ArcGIS.Display.ITextDrawSupport.GetDrawText(string origText, out string pParsedText,
            out object pPositions)
        {
            pParsedText = "";
            pPositions = "";
            if (this.m_DenominatorTextSymbol != null)
        ...
        void ESRI.ArcGIS.Display.IWordBoundaries.QueryWordBoundaries(int hDC, ITransformation displayTransform,
            IGeometry Geometry, IGeometryBag boundaries)
        {
            if (this.m_DenominatorTextSymbol != null)
            {
                (this.m_DenominatorTextSymbol as IWordBoundaries).QueryWordBoundaries(hDC, displayTransform, Geometry,
                    boundaries);
            }
        }
