...
namespace Yutai.ArcGIS.Common.Symbol
{
    public class MyStyleGallery : IStyleGallery, IStyleGalleryStorage
    {
        ...
        {
            new MyMarkerSymbolStyleGalleryClass(), new MyLineSymbolStyleGalleryClass(),
            new MyFillSymbolStyleGalleryClass(), new MyColorSymbolStyleGalleryClass(),
            new MyTextSymbolStyleGalleryClass(), new MyColorRampsSymbolStyleGalleryClass(),
            new MyNorthArrowStyleGalleryClass(), new MyScaleBarStyleGalleryClass(), new MyScaleTextStyleGalleryClass(),
            new MyLinePatchStyleGalleryClass(), new MyAreaPatchStyleGalleryClass(), new MyBorderStyleGalleryClass(),
            new MyBackgroundStyleGalleryClass(), new MyShadowStyleGalleryClass(), new MyLegendItemStyleGalleryClass(),
            new MyMapGridStyleGalleryClass(), new MyLabelStyleGalleryClass(),
            new RepresentationMarkerStyleGalleryClass(), new RepresentationRuleStyleGalleryClass()
        };
        ...
        {
            get { return (int) this.istyleGalleryClass_0.Length; }
        }
        ...
        {
            get { return this.iarray_0.Element[int_0] as string; }
        }
