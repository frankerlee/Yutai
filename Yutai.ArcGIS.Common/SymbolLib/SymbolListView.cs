        ...
        public event SymbolListView.OnValueChangedHandler OnValueChanged
        {
            add
            {
                ...
                do
                {
                    ...
                    SymbolListView.OnValueChangedHandler value2 =
                        (SymbolListView.OnValueChangedHandler) System.Delegate.Combine(onValueChangedHandler2, value);
                    onValueChangedHandler =
                        System.Threading.Interlocked.CompareExchange<SymbolListView.OnValueChangedHandler>(
            ...
            remove
            {
                ...
                do
                {
                    onValueChangedHandler2 = onValueChangedHandler;
                    SymbolListView.OnValueChangedHandler value2 =
                        (SymbolListView.OnValueChangedHandler) System.Delegate.Remove(onValueChangedHandler2, value);
                    onValueChangedHandler =
                        System.Threading.Interlocked.CompareExchange<SymbolListView.OnValueChangedHandler>(
                            ref this.onValueChangedHandler_0, value2, onValueChangedHandler2);
                } while (onValueChangedHandler != onValueChangedHandler2);
            ...
            if (this.bool_1 && base.SelectedItems.Count > 0)
            {
                ...
                if (base.View == System.Windows.Forms.View.LargeIcon)
                {
                    if (this.int_1 > itemRect.Bottom)
                    {
                        ...
                        if (this.int_0 >= itemRect2.Left && this.int_0 <= itemRect2.Right && this.int_1 >= itemRect2.Top &&
                            this.int_1 <= itemRect2.Bottom)
                        {
                            this.int_2 = 0;
                            this.bool_0 = false;
