...
namespace Yutai.ArcGIS.Common.SymbolLib
{
    public class FontListView : System.Windows.Forms.UserControl
    {
        ...
        public event SelectedIndexChangedHandler SelectedIndexChanged
        {
            add
            {
                ...
                do
                {
                    ...
                    SelectedIndexChangedHandler value2 =
                        (SelectedIndexChangedHandler) System.Delegate.Combine(selectedIndexChangedHandler2, value);
                    selectedIndexChangedHandler =
                        System.Threading.Interlocked.CompareExchange<SelectedIndexChangedHandler>(
                            ref this.selectedIndexChangedHandler_0, value2, selectedIndexChangedHandler2);
            ...
            remove
            {
                ...
                do
                {
                    selectedIndexChangedHandler2 = selectedIndexChangedHandler;
                    SelectedIndexChangedHandler value2 =
                        (SelectedIndexChangedHandler) System.Delegate.Remove(selectedIndexChangedHandler2, value);
                    selectedIndexChangedHandler =
                        System.Threading.Interlocked.CompareExchange<SelectedIndexChangedHandler>(
                            ref this.selectedIndexChangedHandler_0, value2, selectedIndexChangedHandler2);
                } while (selectedIndexChangedHandler != selectedIndexChangedHandler2);
        ...
        private void FontListView_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
        {
            ...
            System.Windows.Forms.ControlPaint.DrawBorder3D(e.Graphics, base.ClientRectangle,
                System.Windows.Forms.Border3DStyle.Adjust, (System.Windows.Forms.Border3DSide) 0);
        }
        ...
        protected override bool ProcessCmdKey(ref System.Windows.Forms.Message message_0,
            System.Windows.Forms.Keys keys_0)
        {
            bool result;
