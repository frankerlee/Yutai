...
{
    public class BackgroundDraw : StyleDraw
    {
        public BackgroundDraw(IBackground ibackground_0) : base(ibackground_0)
        {
        }

        public override void Draw(int int_0, Rectangle rectangle_0, double double_0, double double_1)
        {
            IStyleGalleryClass styleGalleryClass = new BackgroundStyleGalleryClass();
