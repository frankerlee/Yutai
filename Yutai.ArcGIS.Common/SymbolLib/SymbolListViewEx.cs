...
namespace Yutai.ArcGIS.Common.SymbolLib
{
    ...
    public class SymbolListViewEx : System.Windows.Forms.ListView
    {
        ...
        public event SymbolListViewEx.OnValueChangedHandler OnValueChanged
        {
            add
            {
                ...
                do
                {
                    ...
                    SymbolListViewEx.OnValueChangedHandler value2 =
                        (SymbolListViewEx.OnValueChangedHandler) System.Delegate.Combine(onValueChangedHandler2, value);
                    onValueChangedHandler =
                        System.Threading.Interlocked.CompareExchange<SymbolListViewEx.OnValueChangedHandler>(
                            ref this.onValueChangedHandler_0, value2, onValueChangedHandler2);
            ...
            remove
            {
                ...
                do
                {
                    onValueChangedHandler2 = onValueChangedHandler;
                    SymbolListViewEx.OnValueChangedHandler value2 =
                        (SymbolListViewEx.OnValueChangedHandler) System.Delegate.Remove(onValueChangedHandler2, value);
                    onValueChangedHandler =
                        System.Threading.Interlocked.CompareExchange<SymbolListViewEx.OnValueChangedHandler>(
                            ref this.onValueChangedHandler_0, value2, onValueChangedHandler2);
                } while (onValueChangedHandler != onValueChangedHandler2);
        ...
        private static extern System.IntPtr SendMessage(System.IntPtr intptr_0, int int_3, System.IntPtr intptr_1,
            System.IntPtr intptr_2);
        ...
        public int[] GetColumnOrder()
        {
            System.IntPtr intPtr =
                System.Runtime.InteropServices.Marshal.AllocHGlobal(
                    System.Runtime.InteropServices.Marshal.SizeOf(typeof(int))*base.Columns.Count);
            int[] result;
            if (
                SymbolListViewEx.SendMessage(base.Handle, 4155, new System.IntPtr(base.Columns.Count), intPtr).ToInt32() ==
                0)
            {
                ...
                if (this.listViewItem_0 != null)
                {
                    if (this.int_0 != -1 && this.listViewItem_0.SubItems[this.int_0].Text != this.textBox_0.Text)
                    {
                        ...
                        if (this.int_0 == 0)
                        {
                            ...
                            {
                                (this.listViewItem_0.Tag as SymbolListViewEx.ItemData).StyleGalleryItem.Name =
                                    this.textBox_0.Text;
                            }
                            else
                            {
                        ...
                        {
                            (this.listViewItem_0.Tag as SymbolListViewEx.ItemData).StyleGalleryItem.Category =
                                this.textBox_0.Text;
                        }
                        else
                        {
        ...
        private void SymbolListViewEx_MouseDoubleClick(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            if (this.bool_1 && base.SelectedItems.Count > 0)
            {
                Rectangle itemRect = base.GetItemRect(base.SelectedIndices[0],
                    System.Windows.Forms.ItemBoundsPortion.Icon);
                if (base.View == System.Windows.Forms.View.LargeIcon)
                {
                    if (this.int_2 > itemRect.Bottom)
                    {
                        ...
                        Rectangle itemRect2 = base.GetItemRect(base.SelectedIndices[0],
                            System.Windows.Forms.ItemBoundsPortion.Label);
                        if (this.int_1 >= itemRect2.Left && this.int_1 <= itemRect2.Right && this.int_2 >= itemRect2.Top &&
                            this.int_2 <= itemRect2.Bottom)
                        {
                            this.int_0 = 0;
                            this.bool_0 = false;
                ...
                else if (this.int_1 > itemRect.Right)
                {
                    ...
                    if (base.SelectedItems.Count == 1)
                    {
                        ...
                        this.int_0 = i;
                        this.listViewItem_0 = base.SelectedItems[0];
                        Rectangle itemRect3 = base.GetItemRect(base.Items.IndexOf(this.listViewItem_0),
                            System.Windows.Forms.ItemBoundsPortion.Label);
