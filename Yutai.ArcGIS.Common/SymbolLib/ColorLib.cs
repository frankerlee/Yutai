...
namespace Yutai.ArcGIS.Common.SymbolLib
{
	internal class ColorLib
	{
		...
		public static IColor Red
		{
			get
			{
				return ColorLib.CreatColor(255, 255, 0, 0);
			}
		}
		...
		public static IColor Green
		{
			get
			{
				return ColorLib.CreatColor(255, 0, 255, 0);
			}
		}
		...
		public static IColor Blue
		{
			get
			{
				return ColorLib.CreatColor(255, 0, 0, 255);
			}
		}
		...
		public static IColor Yellow
		{
			get
			{
				return ColorLib.CreatColor(255, 255, 255, 0);
			}
		}
		...
		public static IColor Black
		{
			get
			{
				return ColorLib.CreatColor((int)Color.Black.A, (int)Color.Black.R, (int)Color.Black.G, (int)Color.Black.B);
			}
		}
		...
		public static IColor Orange
		{
			get
			{
				return ColorLib.CreatColor((int)Color.Orange.A, (int)Color.Orange.R, (int)Color.Orange.G, (int)Color.Orange.B);
			}
		}
