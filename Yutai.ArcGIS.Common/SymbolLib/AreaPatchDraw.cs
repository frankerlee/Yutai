...
{
    public class AreaPatchDraw : StyleDraw
    {
        public AreaPatchDraw(IAreaPatch iareaPatch_0) : base(iareaPatch_0)
        {
        }

        public override void Draw(int int_0, Rectangle rectangle_0, double double_0, double double_1)
        {
            IStyleGalleryClass styleGalleryClass = new AreaPatchStyleGalleryClass();
