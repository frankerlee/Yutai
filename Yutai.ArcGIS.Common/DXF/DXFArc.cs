...
namespace Yutai.ArcGIS.Common.DXF
{
	public class DXFArc : DXFFigure
	{
		...
		public override bool IntersecRect(Rect aRect)
		{
			...
			rectangle = Rectangle.Intersect(new Rectangle(aRect.X1, aRect.Y1, aRect.X2, aRect.Y2), new Rectangle((int)Math.Round((double)(this.data.point.X - this.data.radius)), (int)Math.Round((double)(this.data.point.Y - this.data.radius)), (int)Math.Round((double)(this.data.point.X + this.data.radius)), (int)Math.Round((double)(this.data.point.Y + this.data.radius))));
