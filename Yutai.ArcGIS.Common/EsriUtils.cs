...
namespace Yutai.ArcGIS.Common
{
        ...
        public class EsriUtils
        {
            ...
            public static ILayer[] GetChildLayers(ILayer esriLayer, bool includeContainerObjects)
            {
                ...
                {
                    esriLayerArrayList = EsriUtils.addLayerToArrayList(esriLayer, includeContainerObjects, esriLayerArrayList);
            ...
            {
                if ((EsriUtils.GeometryIsValid(inputGeometry) == false) || (distanceInFeet == 0) || (inputGeometry is ITopologicalOperator == false))
                    return null;
