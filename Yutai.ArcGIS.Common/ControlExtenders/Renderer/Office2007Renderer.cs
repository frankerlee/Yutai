...
namespace Yutai.ArcGIS.Common.ControlExtenders.Renderer
{
    public class Office2007Renderer : ToolStripProfessionalRenderer
    {
        ...
        private void method_4(Graphics graphics_0, ToolStripSplitButton toolStripSplitButton_0, Class7 class7_0,
            Class7 class7_1, Class7 class7_2)
        {
                    ...
                    using (
                        LinearGradientBrush brush =
                            new LinearGradientBrush(
                                new Rectangle(rectangle.X + x, rectangle.Top, 1, rectangle.Height + 1), class7_2.Border1,
                                class7_2.Border2, 90f))
                    {
        ...
        private void method_8(Graphics graphics_0, Rectangle rectangle_0, Class7 class7_0)
        {
            ...
            using (
                LinearGradientBrush brush = new LinearGradientBrush(rectangle3, class7_0.InsideTop1, class7_0.InsideTop2,
                    90f))
            {
                using (
                    LinearGradientBrush brush2 = new LinearGradientBrush(rectangle4, class7_0.InsideBottom1,
                        class7_0.InsideBottom2, 90f))
                {
            ...
            rectangle4.Inflate(1, 1);
            using (
                LinearGradientBrush brush3 = new LinearGradientBrush(rectangle3, class7_0.FillTop1, class7_0.FillTop2,
                    90f))
            {
                using (
                    LinearGradientBrush brush4 = new LinearGradientBrush(rectangle4, class7_0.FillBottom1,
                        class7_0.FillBottom2, 90f))
                {
                    rectangle_0.Inflate(-1, -1);
                    height = rectangle_0.Height/2;
                    rect = new Rectangle(rectangle_0.X, rectangle_0.Y, rectangle_0.Width, height);
        ...
        private void method_9(Graphics graphics_0, Rectangle rectangle_0, Class7 class7_0)
        {
            using (new UseAntiAlias(graphics_0))
            {
                ...
                rect.Inflate(1, 1);
                using (
                    LinearGradientBrush brush = new LinearGradientBrush(rect, class7_0.Border1, class7_0.Border2, 90f))
                {
                    brush.SetSigmaBellShape(0.5f);
                    using (Pen pen = new Pen(brush))
                    {
        ...
        private static void old_acctor_mc()
        {
            ...
            _gripLight = _c5;
            _itemContextItemEnabledColors = new Class7(_r1, _r2, _r3, _r4, _r5, _r6, _r7, _r8,
                Color.FromArgb(217, 203, 150), Color.FromArgb(192, 167, 118));
            _itemDisabledColors = new Class7(_c4, _c6, Color.FromArgb(236, 236, 236), Color.FromArgb(230, 230, 230), _c6,
        ...
        private class Class7
        {
            ...
            public Class7(Color color_0, Color color_1, Color color_2, Color color_3, Color color_4, Color color_5,
