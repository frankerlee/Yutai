...
namespace Yutai.ArcGIS.Common.Excel
{
    public class ExcelBase
    {
        ...
        {
            Range range =
                this.application_0.Range[this.application_0.Cells[int_0, int_1], this.application_0.Cells[int_2, int_3]];
            return range;
        }
        ...
        {
            Range range =
                this.application_0.Range[
                    string.Concat(string_1, int_0.ToString()), string.Concat(string_2, int_1.ToString())];
            return range;
        }
        ...
        {
            Range rows =
                (Range) this.application_0.Rows[string.Concat(int_1.ToString(), ":", int_1.ToString()), this.object_0];
            rows.Select();
