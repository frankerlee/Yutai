...
namespace Yutai.ArcGIS.Common.Helpers
{
    public class SpatialReferenceHelper
    {
        ...
        public static double DistanceOfTwoEarthPoints(double lng1, double lat1, double lng2, double lat2, GaussSphere gs)
        {
            ...
            double num5 = 2.0*
                          Math.Asin(
                              Math.Sqrt(Math.Pow(Math.Sin(num3/2.0), 2.0) +
                                        ((Math.Cos(d)*Math.Cos(num2))*Math.Pow(Math.Sin(num4/2.0), 2.0))));
        ...
        public static void GaussToGeo(double y, double x, short DH, out double L, out double B, double LP)
        {
            ...
            double num6 = (((((27.11115372595 + (9.02468257083*num8)) - (0.00579740442*Math.Pow(num8, 2.0))) -
                             (0.00043532572*Math.Pow(num8, 3.0))) + (4.857285E-05*Math.Pow(num8, 4.0))) +
                           (2.15727E-06*Math.Pow(num8, 5.0))) - (1.9399E-07*Math.Pow(num8, 6.0));
            ...
            double num5 = num6 -
                          ((((1.0 + num7)*num2)/num9)*
                           (((90.0*Math.Pow(num3, 2.0)) -
                             ((7.5*(((5.0 + (3.0*Math.Pow(num2, 2.0))) + num7) - ((9.0*num7)*Math.Pow(num2, 2.0))))*
                              Math.Pow(num3, 4.0))) +
                            ((0.25*((61.0 + (90.0*Math.Pow(num2, 2.0))) + (45.0*Math.Pow(num2, 4.0))))*
                             Math.Pow(num3, 6.0))));
            double num4 = (((180.0*num3) - ((30.0*((1.0 + (2.0*Math.Pow(num2, 2.0))) + num7))*Math.Pow(num3, 3.0))) +
                           ((1.5*((5.0 + (28.0*Math.Pow(num2, 2.0))) + (24.0*Math.Pow(num2, 4.0))))*Math.Pow(num3, 5.0)))/
                          (num9*Math.Cos((num6*num9)/180.0));
        ...
        public static void GeoToGauss(double jd, double wd, short DH, short DH_width, out double y, out double x,
            double LP)
        {
            double num2;
            ...
            double num8 = (30.870794749999998*wd) -
                          (((((32005.7799*num10) + (133.9238*Math.Pow(num10, 3.0))) + (0.6976*Math.Pow(num10, 5.0))) +
                            (0.0039*Math.Pow(num10, 7.0)))*num11);
            ...
            x = num8 +
                ((num7*num)*
                 (((0.5*Math.Pow(num9, 2.0)) +
                   (((((5.0 - Math.Pow(num, 2.0)) + (9.0*num6)) + (4.0*Math.Pow(num6, 2.0)))*Math.Pow(num9, 4.0))/24.0)) +
                  ((((61.0 - (58.0*Math.Pow(num, 2.0))) + Math.Pow(num, 4.0))*Math.Pow(num9, 6.0))/720.0)));
            y = num7*
                ((num9 + ((((1.0 - Math.Pow(num, 2.0)) + num6)*Math.Pow(num9, 3.0))/6.0)) +
                 ((((((5.0 - (18.0*Math.Pow(num, 2.0))) + Math.Pow(num, 4.0)) + (14.0*num6)) -
                    ((58.0*num6)*Math.Pow(num, 2.0)))*Math.Pow(num9, 5.0))/120.0));
        }
        ...
        private void GKTransform(double x, double y, ref double B, ref double L, double center, int n)
        {
            ...
            double num2 = a +
                          (Math.Cos(a)*
                           ((((0.00505250559291393*num4) - (2.98473350966158E-05*Math.Pow(num4, 3.0))) +
                             (2.41627215981336E-07*Math.Pow(num4, 5.0))) - (2.22241909461273E-09*Math.Pow(num4, 7.0))));
            ...
            B = ((num2 - ((num9*Math.Pow(num10, 2.0))/2.0)) +
                 ((((((5.0 + (3.0*num11)) + num8) - ((9.0*num8)*num11))*num9)*Math.Pow(num10, 4.0))/24.0)) -
                (((((61.0 + (90.0*num11)) + (45.0*Math.Pow(num11, 2.0)))*num9)*Math.Pow(num10, 6.0))/720.0);
            double num13 = 1.0/Math.Cos(num2);
            L = (((num13*num10) - (((((1.0 + (2.0*num11)) + num8)*num13)*Math.Pow(num10, 3.0))/6.0)) +
                 (((((((5.0 + (28.0*num11)) + (24.0*Math.Pow(num11, 2.0))) + (6.0*num8)) + ((8.0*num8)*num11))*num13)*
                   Math.Pow(num10, 5.0))/120.0)) + center;
        }
