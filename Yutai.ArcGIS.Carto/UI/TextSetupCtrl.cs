...
namespace Yutai.ArcGIS.Carto.UI
{
    public class TextSetupCtrl : UserControl, IPropertyPage, IPropertyPageEvents
    {
        ...
        private void InitializeComponent()
        {
            ...
            bits = new int[4];
            this.txtCharacterSpace.EditValue = new decimal(bits);
            ...
            bits = new int[4];
            bits[0] = 360;
            this.txtCharacterSpace.Properties.MaxValue = new decimal(bits);
            bits = new int[4];
            bits[0] = 360;
            bits[3] = -2147483648;
            this.txtCharacterSpace.Properties.MinValue = new decimal(bits);
            ...
            bits = new int[4];
            this.txtLeading.EditValue = new decimal(bits);
            ...
            bits = new int[4];
            bits[0] = 360;
            this.txtLeading.Properties.MaxValue = new decimal(bits);
            bits = new int[4];
            bits[0] = 360;
            bits[3] = -2147483648;
            this.txtLeading.Properties.MinValue = new decimal(bits);
