...
namespace Yutai.ArcGIS.Carto.UI
{
    public class frmCalibratedMapBorder : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            bits = new int[4];
            bits[0] = 100;
            this.txtBorderWidth.Properties.MaxValue = new decimal(bits);
            ...
            bits = new int[4];
            this.txtInterval.EditValue = new decimal(bits);
            ...
            bits = new int[4];
            bits[0] = 100;
            this.txtInterval.Properties.MaxValue = new decimal(bits);
            bits = new int[4];
            bits[0] = 100;
            bits[3] = -2147483648;
            this.txtInterval.Properties.MinValue = new decimal(bits);
