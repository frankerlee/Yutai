...
{
    internal class UniqueValueRendererCtrl : UserControl, IUserControl
    {
        ...
        private void btnAddAllValues_Click(object sender, EventArgs e)
        {
            ...
            this.ilist_0.Clear();
            this.iuniqueValueRenderer_0.RemoveAllValues();
            if ((this.cboFields.SelectedIndex != -1) && this.GetUniqueValues(this.ilayer_0, (this.cboFields.SelectedItem as FieldWrap).Name, this.ilist_0))
            {
                ...
                while (true)
                {
                    ...
                    try
                    {
                        ...
                        objArray[3] = this.method_3(this.method_4(), (this.cboFields.SelectedItem as FieldWrap).Name, this.ilist_0[num].ToString()).ToString();
            ...
            if (this.cboFields.SelectedIndex != -1)
            {
                ...
                if (values.ShowDialog() == DialogResult.OK)
                {
                    ...
                    for (int i = 0; i < values.SelectedItems.Count; i++)
                    {
                        ...
                        objArray[3] = this.method_3(this.method_4(), (this.cboFields.SelectedItem as FieldWrap).Name, objArray[1].ToString()).ToString();
                        this.iuniqueValueRenderer_0.AddValue(objArray[1].ToString(), null, symbol2);
                        this.listView1.Add(objArray);
                    }
                }
        ...
        private void InitializeComponent()
        {
            ...
            this.label2.Location = new System.Drawing.Point(0xc0, 11);
            ...
            this.cboColorRamp.Location = new System.Drawing.Point(0xf8, 8);
            ...
            this.btnAddAllValues.Location = new System.Drawing.Point(0x4c, 0xd0);
            ...
            this.btnAddValue.Location = new System.Drawing.Point(160, 0xd0);
            ...
            this.btnDelete.Location = new System.Drawing.Point(0xe8, 0xd0);
            this.btnDelete.Name = "btnDelete";
            this.btnDelete.Size = new Size(80, 0x18);
            this.btnDelete.TabIndex = 10;
            this.btnDelete.Text = "删除";
            this.btnDelete.Click += new EventHandler(this.btnDelete_Click);
            this.btnDeleteAll.Location = new System.Drawing.Point(0x138, 0xd0);
            ...
            this.btnMoveUp.Location = new System.Drawing.Point(0x180, 0x38);
            this.btnMoveUp.Name = "btnMoveUp";
            this.btnMoveUp.Size = new Size(0x18, 0x18);
            this.btnMoveUp.TabIndex = 0x31;
        ...
        private void menuitemUnGroup_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    flag = true;
                    ex.SubItems[3].Text = this.method_3(this.method_4(), (this.cboFields.SelectedItem as FieldWrap).Name, strArray[0]).ToString();
                }
                ...
                for (int i = 1; i < strArray.Length; i++)
                {
                    ...
                    objArray[1] = str2;
                    objArray[2] = str2;
                    objArray[3] = !flag ? "?" : this.method_3(this.method_4(), (this.cboFields.SelectedItem as FieldWrap).Name, str2).ToString();
                    this.listView1.Add(objArray);
                }
            }
            catch (Exception)
