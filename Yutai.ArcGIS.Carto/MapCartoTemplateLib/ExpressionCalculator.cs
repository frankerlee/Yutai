...
namespace Yutai.ArcGIS.Carto.MapCartoTemplateLib
{
    public class ExpressionCalculator
    {
        ...
        public object Calculate()
        {
            try
            {
                return expressionTree_1.Calculate(ParamList);
            }
            catch (Exception)
            {
            }
        ...
        public bool IsFuction(string string_0, out int int_0)
        {
            ...
            if ((string_0.IndexOf("floor(", StringComparison.OrdinalIgnoreCase) == 0) ||
                (string_0.IndexOf("atan2(", StringComparison.OrdinalIgnoreCase) == 0))
            {
                int_0 = 5;
                return true;
            }
            ...
            if ((string_0.IndexOf("log10(", StringComparison.OrdinalIgnoreCase) == 0) ||
                ...
                (string_0.IndexOf("acos(", StringComparison.OrdinalIgnoreCase) == 0) ||
        ...
        {
            return (char_0 == '+') || (char_0 == '-') || (char_0 == '*') || (char_0 == '/') || (char_0 == '%') ||
                   (char_0 == '?');
        }
        ...
        public SortedList<string, object> ParamList { get; set; } = new SortedList<string, object>();
    }
}