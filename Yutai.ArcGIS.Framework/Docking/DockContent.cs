...
namespace Yutai.ArcGIS.Framework.Docking
{
    public class DockContent : Form, IDockContent
    {
        ...
        [LocalizedDescription("DockContent_AutoHidePortion_Description"), DefaultValue((double) 0.25), LocalizedCategory("Category_Docking")]
        ...
        [LocalizedDescription("DockContent_CloseButton_Description"), LocalizedCategory("Category_Docking"), DefaultValue(true)]
        ...
        [LocalizedCategory("Category_Docking"), DefaultValue(false), LocalizedDescription("DockContent_HideOnClose_Description")]
        ...
        [LocalizedCategory("Category_Docking"), DefaultValue(0), LocalizedDescription("DockContent_ShowHint_Description")]
        ...
        [LocalizedDescription("DockContent_TabPageContextMenu_Description"), DefaultValue((string) null), LocalizedCategory("Category_Docking")]
        ...
        [LocalizedDescription("DockContent_TabPageContextMenuStrip_Description"), LocalizedCategory("Category_Docking"), DefaultValue((string) null)]
        ...
        [Localizable(true), LocalizedDescription("DockContent_TabText_Description"), DefaultValue((string) null), LocalizedCategory("Category_Docking")]
        ...
        [Category("Appearance"), LocalizedDescription("DockContent_ToolTipText_Description"), DefaultValue((string) null), Localizable(true)]
