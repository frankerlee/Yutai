...
{
    public sealed class ToolSceneTargetCenter : YutaiTool
    {
        ...
        public ToolSceneTargetCenter(IAppContext context, IScenePlugin plugin)
        {
            OnCreate(context);
            _plugin = plugin;
        }
        public override void OnCreate(object object_0)
        {
            ...
            _key = "Scene_TargetCenter";
            _itemType = RibbonItemType.Tool;
            this.m_category = "视图";
            this.m_caption = "目标为中心";
            this.m_toolTip = "以目标为中心显示";
            this.m_name = "Scene_TargetCenter";
            this.m_message = "以目标为中心显示";

            this.m_bitmap = Properties.Resources.TargetCenter;
            
            this.cursor_0 = new System.Windows.Forms.Cursor(base.GetType().Assembly.GetManifestResourceStream("Yutai.Plugins.Scene.Resources.Cursor.targetcenter.cur"));
