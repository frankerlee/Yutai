...
{
    public class CmdHideField : YutaiCommand
    {
        private CompContextMenuStrip _menuStrip;

        public CmdHideField(IAppContext context, CompContextMenuStrip menuStrip)
        {
            _context = context;
        ...
        private void OnCreate()
        {
            ...
            base.m_bitmap = null;
            base.m_name = "mnuHideField";
            base._key = "mnuHideField";
            base.m_toolTip = "关闭字段";
