...
{
    public class frmVCT2FeatureClass : Form
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmVCT2FeatureClass));
            ...
            this.lblSelectObjects.Size = new Size(0x47, 12);
            this.lblSelectObjects.TabIndex = 8;
            this.lblSelectObjects.Text = "VCT数据文件";
            ...
            this.panel1.Size = new Size(0x160, 240);
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            if (this.CanDo())
            {
                ...
                reader.ProgressMessage += new ProgressMessageHandle(this.method_6);
                object obj2 = this.iname_0.Open();
                if (obj2 is IFeatureWorkspace)
                {
                    reader.Workspace = obj2 as IWorkspace;
                }
                else if (obj2 is IFeatureDataset)
                {
                    reader.FeatureDataset = obj2 as IFeatureDataset;
                }
