...
namespace Yutai.ArcGIS.Catalog.VCT
{
    public class CoFieldClass : IDisposable, ICoClone, ICoField
    {
        ...
        {
            return new CoFieldClass
            {
                AliasName = this.string_0,
                DefaultValue = this.string_1,
                Enable = this.bool_1,
                ID = this.string_3,
                Length = this.int_0,
                Name = this.string_2,
                Precision = this.int_1,
                Required = this.bool_0,
                Type = this.coFieldType_0
            };
        }
