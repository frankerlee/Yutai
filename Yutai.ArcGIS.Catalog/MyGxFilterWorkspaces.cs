...
namespace Yutai.ArcGIS.Catalog
{
    public class MyGxFilterWorkspaces : IGxObjectFilter
    {
        ...
        {
            if (((igxObject_0 is IGxDiskConnection) || (igxObject_0 is IGxFolder)) || (igxObject_0 is IGxRemoteDatabaseFolder))
            {
        ...
        {
            return (((((igxObject_0 is IGxDiskConnection) || (igxObject_0 is IGxFolder)) || (igxObject_0 is IGxRemoteDatabaseFolder)) || (igxObject_0 is IGxBasicObject)) || (igxObject_0 is IGxDatabase));
        }
