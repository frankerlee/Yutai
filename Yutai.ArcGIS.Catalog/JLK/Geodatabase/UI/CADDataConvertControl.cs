namespace JLK.Geodatabase.UI
{
    ...
    internal class CADDataConvertControl : UserControl
    {
        ...
        private void CADDataConvertControl_Load(object sender, EventArgs e)
        {
            this.method_5();
        }
        ...
        public void Do()
        {
            try
            {
                ...
                (dataloaders.Converter as IFeatureProgress_Event).add_Step(new IFeatureProgress_StepEventHandler(this.method_12));
        ...
        {
            ResourceManager manager = new ResourceManager(typeof(CADDataConvertControl));
