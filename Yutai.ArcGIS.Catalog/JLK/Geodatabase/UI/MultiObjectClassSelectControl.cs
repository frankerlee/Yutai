    ...
    public class MultiObjectClassSelectControl : UserControl
    {
        ...
        public void Do()
        {
            ...
            try
            {
                ...
                (dataloaders.Converter as IFeatureProgress_Event).add_Step(new IFeatureProgress_StepEventHandler(this.method_10));
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(MultiObjectClassSelectControl));
