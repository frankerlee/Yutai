namespace JLK.Geodatabase.UI
{
    ...
    public class frmPropertySheet : Form, IPropertySheet, IPropertySheetEvents
    {
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(frmPropertySheet));
