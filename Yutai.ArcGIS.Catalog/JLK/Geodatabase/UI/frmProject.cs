namespace JLK.Geodatabase.UI
{
    ...
    public class frmProject : Form, IProjectForm
    {
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(frmProject));
            ...
            this.btnSelectIn.Image = (Image) manager.GetObject("btnSelectIn.Image");
            ...
            this.btnSelectOut.Image = (Image) manager.GetObject("btnSelectOut.Image");
            ...
            this.btnSR.Image = (Image) manager.GetObject("btnSR.Image");
        ...
        public IFeatureDataConverter FeatureProgress
        {
            set
            {
                ...
                this.ifeatureProgress_Event_0.add_Step(new IFeatureProgress_StepEventHandler(this.method_7));
            }
        }
    }
}
