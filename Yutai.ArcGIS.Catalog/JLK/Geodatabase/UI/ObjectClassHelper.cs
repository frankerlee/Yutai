            ...
            if (this.m_IsFeatureClass)
            {
                ...
                else
                {
                    if (ObjectClassShareData.m_IsShapeFile)
                    {
                        ...
                        {
                            CErrorLog.writeErrorLog(this, exception, "创建shape文件");
                            return null;
                        }
                    }
        ...
        public void InitFields()
        {
            if (this.m_IsFeatureClass)
            {
                ...
                if (this.m_FeatreType == esriFeatureType.esriFTSimple)
                {
                    ...
                    (geometryDef as IGeometryDefEdit).SpatialReference = spatialReference;
                    (field as IFieldEdit).GeometryDef = geometryDef;
                }
