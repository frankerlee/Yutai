namespace JLK.Geodatabase.UI
{
    ...
    internal class RepresentationRulesPage : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            ComponentResourceManager manager = new ComponentResourceManager(typeof(RepresentationRulesPage));
            ...
            this.btnAddLayer.Image = (Image) manager.GetObject("btnAddLayer.Image");
            ...
            this.tnMoveDown.Image = (Image) manager.GetObject("tnMoveDown.Image");
            ...
            this.btnDeleteLayer.Image = (Image) manager.GetObject("btnDeleteLayer.Image");
            ...
            this.btnOther.Image = (Image) manager.GetObject("btnOther.Image");
        ...
        private void RepresentationRulesPage_Load(object sender, EventArgs e)
        {
            ...
            this.represationRuleCtrl1.GeometryType = this.ifeatureClass_0.ShapeType;
