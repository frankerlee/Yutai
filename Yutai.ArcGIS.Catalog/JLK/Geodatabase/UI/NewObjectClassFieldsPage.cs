    ...
    public class NewObjectClassFieldsPage : UserControl
    {
        ...
        public bool Apply()
        {
            ...
            if (NewObjectClassHelper.m_pObjectClassHelper.ObjectClass != null)
            {
                ...
                {
                    IField field;
                    JLK.Utility.CodeDomainEx.CodeDomainEx ex;
                    try
                    {
                    ...
                    if (!ObjectClassShareData.m_IsShapeFile)
                    {
                        ...
                        while (num < this.ilist_0.Count)
                        {
                            ...
                            catch (COMException exception6)
                            {
                                ...
                                (field as IFieldEdit).AliasName = field.Name;
                                if (exception.ErrorCode == -2147220969)
                                {
        ...
        private void InitializeComponent()
        {
            ...
            this.listView2.ValueChanged += new JLK.ControlExtend.ValueChangedHandler(this.method_6);
        ...
        private IFields method_1()
        {
            if (NewObjectClassHelper.m_pObjectClassHelper.IsFeatureClass)
            {
                ...
                if (NewObjectClassHelper.m_pObjectClassHelper.FeatureType == esriFeatureType.esriFTSimple)
                {
                    ...
                    (geometryDef as IGeometryDefEdit).GeometryType = NewObjectClassHelper.m_pObjectClassHelper.ShapeType;
                    (field as IFieldEdit).GeometryDef = geometryDef as IGeometryDefEdit;
            ...
            if (item.Tag == null)
            {
                ...
                if (item.SubItems[1].Text.Length > 0)
                {
                    tag = new FieldClass {
                        ...
                        Type = this.method_8(item.SubItems[1].Text)
                    };
        ...
        private void NewObjectClassFieldsPage_Load(object sender, EventArgs e)
        {
            ...
            (this.icontrolBaseInterface_0[0] as FieldTypeIntegerCtrl).ValueChanged += new JLK.Geodatabase.UI.ValueChangedHandler(this.method_4);
            (this.icontrolBaseInterface_0[1] as FieldTypeIntegerCtrl).ValueChanged += new JLK.Geodatabase.UI.ValueChangedHandler(this.method_4);
            (this.icontrolBaseInterface_0[2] as FieldTypeDoubleCtrl).ValueChanged += new JLK.Geodatabase.UI.ValueChangedHandler(this.method_4);
            (this.icontrolBaseInterface_0[3] as FieldTypeDoubleCtrl).ValueChanged += new JLK.Geodatabase.UI.ValueChangedHandler(this.method_4);
            (this.icontrolBaseInterface_0[4] as FieldTypeTextCtrl).ValueChanged += new JLK.Geodatabase.UI.ValueChangedHandler(this.method_4);
            (this.icontrolBaseInterface_0[5] as FieldTypeDateCtrl).ValueChanged += new JLK.Geodatabase.UI.ValueChangedHandler(this.method_4);
            (this.icontrolBaseInterface_0[6] as FieldTypeObjectIDCtrl).ValueChanged += new JLK.Geodatabase.UI.ValueChangedHandler(this.method_4);
            (this.icontrolBaseInterface_0[7] as FieldTypeGeometryCtrl).ValueChanged += new JLK.Geodatabase.UI.ValueChangedHandler(this.method_4);
            (this.icontrolBaseInterface_0[8] as FieldTypeBlobCtrl).ValueChanged += new JLK.Geodatabase.UI.ValueChangedHandler(this.method_4);
            (this.icontrolBaseInterface_0[9] as FieldTypeRasterCtrl).ValueChanged += new JLK.Geodatabase.UI.ValueChangedHandler(this.method_4);
            (this.icontrolBaseInterface_0[10] as FieldTypeGuidCtrl).ValueChanged += new JLK.Geodatabase.UI.ValueChangedHandler(this.method_4);
