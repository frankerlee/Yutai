namespace JLK.Geodatabase.UI
{
    ...
    public class frmMapInfo2FeatureClass : Form
    {
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(frmMapInfo2FeatureClass));
        ...
        private void method_5()
        {
            ...
            this.labelFN.Text = "处理:" + this.string_0 + "中第 " + this.int_0.ToString() + " 个对象, 共 " + this.int_1.ToString() + " 个对象";
        }
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            if (this.CanDo())
            {
                ...
                convert.add_Step(new IFeatureProgress_StepEventHandler(this.method_5));
