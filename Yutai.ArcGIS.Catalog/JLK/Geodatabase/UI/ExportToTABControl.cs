namespace JLK.Geodatabase.UI
{
    ...
    internal class ExportToTABControl : UserControl
    {
        ...
        public void Do()
        {
            try
            {
                ...
                (convert as IFeatureProgress_Event).add_Step(new IFeatureProgress_StepEventHandler(this.method_9));
        ...
        {
            ResourceManager manager = new ResourceManager(typeof(ExportToTABControl));
