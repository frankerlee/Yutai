namespace JLK.Geodatabase.UI
{
    ...
    public class frmImportCoordinateFile : Form
    {
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(frmImportCoordinateFile));
            ...
            this.btnOpenCoordinateFile.Image = (Image) manager.GetObject("btnOpenCoordinateFile.Image");
            ...
            this.btnSelectCoordinate.Image = (Image) manager.GetObject("btnSelectCoordinate.Image");
        ...
        private IFeatureClass method_1()
        {
            ...
            {
                geometryDef.GeometryType = esriGeometryType.esriGeometryPoint;
            }
            else if (this.cboGeometryType.SelectedIndex == 1)
            {
                geometryDef.GeometryType = esriGeometryType.esriGeometryMultipoint;
            }
            else if (this.cboGeometryType.SelectedIndex == 2)
            {
                geometryDef.GeometryType = esriGeometryType.esriGeometryPolyline;
            }
            ...
            geometryDef.HasZ = this.chkHasZ.Checked;
            geometryDef.HasM = this.chkHasM.Checked;
            SpatialReferenctOperator.ChangeCoordinateSystem(workspace as IGeodatabaseRelease, spatialReference, false);
            geometryDef.SpatialReference = spatialReference;
