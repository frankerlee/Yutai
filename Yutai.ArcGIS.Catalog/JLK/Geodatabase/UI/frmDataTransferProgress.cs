namespace JLK.Geodatabase.UI
{
    ...
    public class frmDataTransferProgress : Form
    {
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(frmDataTransferProgress));
        ...
        public IGeoDBDataTransfer GeoDBTransfer
        {
            set
            {
                ...
                (this.igeoDBDataTransfer_0 as IFeatureProgress_Event).add_Step(new IFeatureProgress_StepEventHandler(this.method_6));
            }
        }
