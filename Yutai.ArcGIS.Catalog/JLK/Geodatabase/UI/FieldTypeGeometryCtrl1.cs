namespace JLK.Geodatabase.UI
{
    ...
    internal class FieldTypeGeometryCtrl1 : UserControl, IControlBaseInterface
    {
        ...
        private void btnSetSR_Click(object sender, EventArgs e)
        {
            ...
            {
                this.igeometryDefEdit_0.SpatialReference = reference.SpatialRefrence;
                this.txtSpatialReference.Text = this.igeometryDefEdit_0.SpatialReference.Name;
                this.ifieldEdit_0.GeometryDef = this.igeometryDefEdit_0;
            }
        }
        ...
        private void cboGeometryType_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.bool_0)
            {
                ...
                {
                    case 0:
                        this.igeometryDefEdit_0.GeometryType = esriGeometryType.esriGeometryPoint;
                        break;

                    case 1:
                        this.igeometryDefEdit_0.GeometryType = esriGeometryType.esriGeometryPolygon;
                        break;

                    case 2:
                        this.igeometryDefEdit_0.GeometryType = esriGeometryType.esriGeometryMultipoint;
                        break;

                    case 3:
                        this.igeometryDefEdit_0.GeometryType = esriGeometryType.esriGeometryMultiPatch;
                        break;

                    case 4:
                        this.igeometryDefEdit_0.GeometryType = esriGeometryType.esriGeometryPolyline;
                        break;
                }
            }
        }
        ...
        private void cboHasM_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.bool_0)
            {
                this.igeometryDefEdit_0.HasM = this.cboHasM.SelectedIndex == 1;
            }
        }
        ...
        private void cboHasZ_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.bool_0)
            {
                this.igeometryDefEdit_0.HasZ = this.cboHasZ.SelectedIndex == 1;
            }
        }
