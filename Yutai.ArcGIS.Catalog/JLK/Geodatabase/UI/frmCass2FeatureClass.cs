namespace JLK.Geodatabase.UI
{
    ...
    public class frmCass2FeatureClass : Form
    {
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(frmCass2FeatureClass));
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            if (this.CanDo())
            {
                ...
                reader.add_Step(new IFeatureProgress_StepEventHandler(this.method_5));
