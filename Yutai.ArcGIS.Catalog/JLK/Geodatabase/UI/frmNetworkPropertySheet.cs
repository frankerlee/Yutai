    ...
    public class frmNetworkPropertySheet : Form
    {
        ...
        private void frmNetworkPropertySheet_Load(object sender, EventArgs e)
        {
            ...
            for (num2 = 0; num2 < this.inetworkDataset_0.AttributeCount; num2++)
            {
                ...
                strArray[3] = Common.GetUsageTypeDescriptor(attribute.UsageType);
                strArray[4] = Common.GetNetworkUnitTypeDescriptor(attribute.Units);
                strArray[5] = Common.GetDataTypeDescriptor(attribute.DataType);
                item = new ListViewItem(strArray);
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(frmNetworkPropertySheet));
