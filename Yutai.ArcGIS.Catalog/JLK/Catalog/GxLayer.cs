namespace JLK.Catalog
{
    ...
    public class GxLayer : IGxObject, IGxLayer, IGxFile, IGxObjectEdit, IGxObjectInternalName, IGxObjectProperties, IGxObjectUI
    {
        ...
        private JLK.Catalog.LayerType method_0(IFeatureClass ifeatureClass_0)
        {
            if (ifeatureClass_0.FeatureType == esriFeatureType.esriFTAnnotation)
            {
                return JLK.Catalog.LayerType.AnnoLayer;
            }
            switch (ifeatureClass_0.ShapeType)
            {
                case esriGeometryType.esriGeometryPoint:
                    return JLK.Catalog.LayerType.PointLayer;

                case esriGeometryType.esriGeometryMultipoint:
                    return JLK.Catalog.LayerType.PointLayer;

                case esriGeometryType.esriGeometryPolyline:
                    return JLK.Catalog.LayerType.LineLayer;

                case esriGeometryType.esriGeometryPolygon:
                    return JLK.Catalog.LayerType.PolygonLayer;
            }
            return JLK.Catalog.LayerType.UnknownLayer;
        }
        ...
        public JLK.Catalog.LayerType LayerType
        {
            get
            {
                if (this.Layer != null)
                {
                    ...
                    {
                        return JLK.Catalog.LayerType.GroupLayer;
                    }
                    if (this.Layer is IRasterLayer)
                    {
                        return JLK.Catalog.LayerType.RasterLayer;
                    }
