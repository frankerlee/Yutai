namespace JLK.Catalog.UI
{
    ...
    internal class SODocumentPropertyPage : UserControl
    {
        ...
        {
            ResourceManager manager = new ResourceManager(typeof(SODocumentPropertyPage));
            ...
            this.btnOpenDocment.Image = (Image) manager.GetObject("btnOpenDocment.Image");
            ...
            base.Name = "SODocumentPropertyPage";
            base.Size = new Size(0x170, 0x130);
            base.Load += new EventHandler(this.SODocumentPropertyPage_Load);
