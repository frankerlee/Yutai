namespace JLK.Catalog
{
    ...
    public class MyGxFilterPersonalGeodatabases : IGxObjectFilter
    {
        ...
        {
            return (((igxObject_0 is IGxDiskConnection) || (igxObject_0 is IGxFolder)) || (((igxObject_0 is IGxDatabase) && !(igxObject_0 as IGxDatabase).IsRemoteDatabase) && (Path.GetExtension(igxObject_0.Name).ToLower() == ".mdb")));
        }
