    ...
    public class CmdEditTarget : YutaiTool, IToolContextMenu
    {
        ...
        public override bool Enabled
        {
            get
            {
                ...
                {
                    if ((_context.FocusMap.LayerCount == 0 || Yutai.ArcGIS.Common.Editor.Editor.EditWorkspace == null ||
                         Yutai.ArcGIS.Common.Editor.Editor.EditMap == null) && _context.CurrentTool == this)
                    {
        ...
        {
            get { return this.pEditTools.Cursor.Handle.ToInt32(); }
        }
        ...
        {
            get { return (System.Windows.Forms.Keys) 131141; }
        }
        ...
        public override void OnCreate(object hook)
        {
            ...
            this.m_cursor =
                new System.Windows.Forms.Cursor(
                    base.GetType().Assembly.GetManifestResourceStream("Yutai.Plugins.Editor.Resources.Cursor.Edit.cur"));
            this.m_caption = "要素编辑";
            this.m_category = "编辑器";
            this.m_toolTip = "编辑";
            this.m_message = "编辑";
        ...
        {
            get { return pEditTools.ContextMenuKeys; }
        }
    }
}