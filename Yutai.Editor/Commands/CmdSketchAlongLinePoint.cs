        ...
        public override void OnDblClick()
        {
            ...
            if (SketchToolAssist.TempLine != null)
            {
                ...
                for (double d = dbp; d < polyline.Length; d += dbp)
                {
                    ...
                    CreateFeatureTool.CreateFeature((IGeometry) contructionPoint, focusMap, Yutai.ArcGIS.Common.Editor.Editor.CurrentEditTemplate.FeatureLayer,isClear);
                    createCount++;
                }
                ...
                {
                    isClear = createCount == 0 ? true : false;
                    CreateFeatureTool.CreateFeature(polyline.FromPoint, focusMap, Yutai.ArcGIS.Common.Editor.Editor.CurrentEditTemplate.FeatureLayer,isClear);
                    CreateFeatureTool.CreateFeature(polyline.ToPoint, focusMap, Yutai.ArcGIS.Common.Editor.Editor.CurrentEditTemplate.FeatureLayer,false);
                }
