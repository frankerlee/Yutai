...
{
    public class TopologyErrorDockPanelService
    {
        private IAppContext _context;
        private TopologyErrorPresenter _presenter;
        private EditorPlugin _plugin;

        public TopologyErrorDockPanelService(IAppContext context, TopologyErrorPresenter presenter, EditorPlugin plugin)
        {
        ...
        public TopologyErrorPresenter Presenter
        {
        ...
        public void Show()
        {
            ...
            {
               // ((ITopologyErrorView)_presenter.GetInternalObject()).ValidateWorkspace();
            }
            ((ITopologyErrorView)_presenter.GetInternalObject()).Initialize(_context);
