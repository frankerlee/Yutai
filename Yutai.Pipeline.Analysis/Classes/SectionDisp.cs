...
namespace Yutai.Pipeline.Analysis.Classes
{
    public class SectionDisp
    {
        ...
        {
            get { return 25.4f/this.graphics_0.DpiX; }
        }

        public bool CustomScale
        {
            get { return this.KsymctcwAN; }
            set { this.KsymctcwAN = value; }
        }
        ...
        public double TranAngle
        {
            ...
            set { this.double_4 = value; }
        }

        public float PrintScaleX
        {
            get { return this.float_26; }
            set { this.float_26 = value; }
        }

        public float PrintScaleY
        {
            get { return this.float_27; }
            set { this.float_27 = value; }
        }
        ...
        {
            Rectangle clientRectangle = this.form_0.ClientRectangle;
            PointF pointF = new PointF((float) ((clientRectangle.Left + clientRectangle.Right)/2),
                (float) ((clientRectangle.Top + clientRectangle.Bottom)/2));
        ...
        private void vmEmJgFbCo()
        {
            ...
            rectangleF.Height = this.float_21 - this.float_2 - this.float_3 - this.float_10 - this.float_11 +
                                this.OnePixelInMM;
        ...
        private void method_4()
        {
            ...
            this.graphics_0.DrawLine(pen, (this.float_16 + this.float_0)*this.float_28,
                (this.float_17 + this.float_2 + this.float_10 + this.float_11)*this.float_28,
                (this.float_18 - this.float_1)*this.float_28,
                (this.float_17 + this.float_2 + this.float_10 + this.float_11)*this.float_28);
            this.graphics_0.DrawLine(pen, (this.float_16 + this.float_0)*this.float_28,
                (this.float_17 + this.float_2 + this.float_10 + this.float_11)*this.float_28,
                (this.float_16 + this.float_0)*this.float_28, num4);
            this.graphics_0.DrawLine(pen, (this.float_18 - this.float_1)*this.float_28,
                (this.float_17 + this.float_2 + this.float_10 + this.float_11)*this.float_28,
                (this.float_18 - this.float_1)*this.float_28, num4);
            this.graphics_0.DrawLine(pen, (this.float_16 + this.float_0)*this.float_28, num4,
                (this.float_18 - this.float_1)*this.float_28, num4);
        ...
        private void method_8()
        {
            ...
            float y = this.float_17 + this.float_2 + this.float_10*this.yQsaxPkehn + this.float_11 + this.float_12 +
                      this.float_13;
        ...
        private void method_16()
        {
            ...
            {
                num3 = this.float_19 -
                       (this.float_3 + this.float_5*(float) this.int_2*this.yQsaxPkehn + num*(float) (num7 + 1L));
                num3 *= this.float_28;
        ...
        public void DrawVerSection(ArrayList pArrPipLines, ArrayList pArrPipePoints, int nSelectIndex)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                for (int j = 0; j < num; j++)
                {
                    ...
                    this.method_31(num6, num7*this.float_28, num8*this.float_28, 5,
                        this.float_5*this.float_28*this.yQsaxPkehn, text, this.bool_2);
                    num7 = num8;
                    num8 += this.float_5*this.yQsaxPkehn;
                    float num10 = (float) gPoint.Z;
                    string text2 = num10.ToString("f3");
                    this.method_31(num6, num7*this.float_28, num8*this.float_28, 5,
                        this.float_5*this.float_28*this.yQsaxPkehn, text2, this.bool_2);
                    num7 = this.float_19 - (this.float_3 + this.float_5);
                    num8 = this.float_19 - this.float_3;
                    string text3 = (num9 - num10).ToString("f3");
                    this.method_31(num6, num7*this.float_28, num8*this.float_28, 5,
                        this.float_5*this.float_28*this.yQsaxPkehn, text3, this.bool_2);
                }
            }
        ...
        public void DrawTranSection(ArrayList pArrPipePoints)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (pipePoint.PointType == PipePoint.SectionPointType.sptPipe)
                {
                    ...
                    this.method_31(num5, num6*this.float_28, num7*this.float_28, 5,
                        this.float_5*this.float_28*this.yQsaxPkehn, text, this.bool_2);
                    num6 = num7;
                    ...
                    this.method_31(num5, num6*this.float_28, num7*this.float_28, 5,
                        this.float_5*this.float_28*this.yQsaxPkehn, pipePoint.strPipeWidthHeight, this.bool_2);
                }
            }
            this.m_arrObjectRects.Clear();
            ...
            if (flag)
            {
                for (int i = 0; i < count; i++)
                {
                    ...
                    if (item1.PointType == PipePoint.SectionPointType.sptPipe)
                    {
                        ...
                        float float19 = this.float_19 -
                                        (this.float_3 + this.float_5*(float) (this.int_2 - 2)*this.yQsaxPkehn -
                                         this.float_5/2f)*this.yQsaxPkehn;
                        ...
                        this.method_32((float) float28, float191*this.float_28, float5*this.float_28, 5,
                            this.float_5*this.float_28*this.yQsaxPkehn, str, Brushes.Red, this.bool_2);
                    }
                }
            }
        }
        ...
        private void method_21(ArrayList arrayList)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (pipePoint.PointType == PipePoint.SectionPointType.sptDrawPoint ||
                    pipePoint.PointType == PipePoint.SectionPointType.sptRoadBorder)
                {
                    ...
                    if (num == 2)
                    {
                        ...
                        else
                        {
                            ...
                            this.m_arrObjectRects.Add(value);
                            this.graphics_0.FillRectangle(Brushes.BurlyWood, rectangleF.X, rectangleF.Y,
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (pipePoint.PointType == PipePoint.SectionPointType.sptMidGreen)
                {
                    ...
                    if (num == 2)
                    {
                        ...
                        GPoint value = new GPoint(x*(double) this.float_28, m*(double) this.float_28);
                        this.m_arrObjectRects.Add(value);
                        this.graphics_0.FillRectangle(Brushes.GreenYellow, rectangleF.X, rectangleF.Y, rectangleF.Width,
                            rectangleF.Height);
                        string str = Application.StartupPath + "\\断面要素\\";
        ...
        private void method_25(ArrayList arrayList)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                for (int j = 0; j < num3; j++)
                {
                    ...
                    if (j > 0)
                    {
                        this.graphics_0.DrawLine(pen, new PointF(num*this.float_28, num2*this.float_28),
                            new PointF(num4*this.float_28, num5*this.float_28));
                        this.method_27(new GPoint((double) (num*this.float_28), (double) (num2*this.float_28)),
                            new GPoint((double) (num4*this.float_28), (double) (num5*this.float_28)));
                    }
                    num = num4;
                    num2 = num5;
                }
        ...
        private void method_26(ArrayList arrayList)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                {
                    this.graphics_0.DrawLine(pen, new PointF(num*this.float_28, num2*this.float_28),
                        new PointF(num3*this.float_28, num4*this.float_28));
                    this.method_27(new GPoint((double) (num*this.float_28), (double) (num2*this.float_28)),
                        new GPoint((double) (num3*this.float_28), (double) (num4*this.float_28)));
                }
                num = num3;
                num2 = num4;
            }
        ...
        private void method_27(GPoint deepCopy, GPoint deepCopy2)
        {
            if (deepCopy.DistanceToPt(deepCopy2) >= 1.0)
            {
                ...
                while (true)
                {
                    ...
                    Pen pen = new Pen(Color.Black, this.OnePixelInMM);
                    this.graphics_0.DrawLine(pen, new PointF((float) deepCopy5.X, (float) deepCopy5.Y),
                        new PointF((float) deepCopy4.X, (float) deepCopy4.Y));
                }
            }
        }
        ...
        private void method_28(ArrayList arrayList)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                for (int j = 0; j < num3; j++)
                {
                    ...
                    if (j > 0)
                    {
                        this.graphics_0.DrawLine(pen3, new PointF(num*this.float_28, num2*this.float_28),
                            new PointF(num4*this.float_28, num5*this.float_28));
                    }
                    num = num4;
                    num2 = num5;
        ...
        private void method_29(ArrayList arrayList)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (pipePoint.PointType == PipePoint.SectionPointType.sptPipe)
                {
                    ...
                    {
                        if (pipePoint.strPipeWidthHeight.IndexOf('x') == -1 &&
                            pipePoint.strPipeWidthHeight.IndexOf('X') == -1)
                        {
                            this.graphics_0.FillEllipse(Brushes.Red, rectangleF.X, rectangleF.Y, rectangleF.Width,
                                rectangleF.Height);
                        }
                        else
                        {
                            this.graphics_0.FillRectangle(Brushes.Red, rectangleF.X, rectangleF.Y, rectangleF.Width,
                                rectangleF.Height);
                        }
                    }
                    else if (pipePoint.strPipeWidthHeight.IndexOf('x') == -1 &&
                             pipePoint.strPipeWidthHeight.IndexOf('X') == -1)
                    {
                        this.graphics_0.FillEllipse(Brushes.White, rectangleF.X, rectangleF.Y, rectangleF.Width,
                            rectangleF.Height);
                    }
                    else
                    {
                        this.graphics_0.FillRectangle(Brushes.White, rectangleF.X, rectangleF.Y, rectangleF.Width,
                            rectangleF.Height);
                    }
                    if (pipePoint.strPipeWidthHeight.IndexOf('x') == -1 &&
                        pipePoint.strPipeWidthHeight.IndexOf('X') == -1)
                    ...
                    {
                        this.graphics_0.DrawRectangle(pen, rectangleF.X, rectangleF.Y, rectangleF.Width,
                            rectangleF.Height);
                    }
                }
            }
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                for (int j = 0; j < num; j++)
                {
                    ...
                    if (j > 0)
                    {
                        ...
                        float num5 = this.float_19 -
                                     (this.float_3 + this.float_5*(float) (this.int_2 - 3)*this.yQsaxPkehn -
                                      this.float_5/2f*this.yQsaxPkehn);
                        num4 *= this.float_28;
                        num5 *= this.float_28;
                        ...
                        if (this.bool_1)
                        {
                            if (i%2 == 0)
                            {
                                this.graphics_0.DrawString(s, font, Brushes.Black, new PointF(num4, num5 - 2f),
                                    stringFormat);
                            }
                            else
                            {
        ...
        private void method_34(ArrayList arrayList)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (pipePoint2.PointType == PipePoint.SectionPointType.sptPipe ||
                    pipePoint2.PointType == PipePoint.SectionPointType.sptMidRoadLine ||
                    pipePoint2.PointType == PipePoint.SectionPointType.sptRoadBorder)
                {
        ...
        public static extern int BitBlt(HandleRef hDesDC, int x, int y, int w, int h, HandleRef hSrcDC, int xSrc,
            int ySrc, int dwRop);
        ...
        public static Bitmap FromGraphics(Graphics g, int w, int h)
        {
            ...
            SectionDisp.BitBlt(new HandleRef(null, graphics.GetHdc()), 0, 0, w, h, new HandleRef(null, g.GetHdc()), 0,
                25, 13369376);
            graphics.ReleaseHdc();
            g.ReleaseHdc();
            return bitmap;
