			...
			if (openFileDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
			{
				...
				if (workspace != null)
				{
					...
					if (featureDataset != null)
					{
						...
						{
							IFeatureClass @partial class = featureClassContainer.get_Class(i);
							if (@partial class != null)
							{
								if (@partial class.FeatureType != (esriFeatureType) 12)
								{
								...
								cadFeatureLayerClass.Name=(@partial class.AliasName);
								cadFeatureLayerClass.FeatureClass=(@partial class);
