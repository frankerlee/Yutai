...
{
	    partial class CustomColumnChooser
    {
	...
	private void InitializeComponent()
		{
			...
			this.ultraComboBandSelector.DisplayLayout.ScrollStyle=ScrollStyle.Immediate;
			this.ultraComboBandSelector.DisplayLayout.ViewStyleBand=(ViewStyleBand.OutlookGroupBy) ;
			this.ultraComboBandSelector.DropDownStyle=(UltraComboStyle.DropDownList);
			...
			this.ultraGridColumnChooser1.DisplayLayout.AutoFitStyle=(AutoFitStyle.ResizeAllColumns);
			...
			this.ultraGridColumnChooser1.DisplayLayout.Override.AllowColSizing=(AllowColSizing.None);
			this.ultraGridColumnChooser1.DisplayLayout.Override.AllowRowLayoutCellSizing=(RowLayoutSizing.None);
			this.ultraGridColumnChooser1.DisplayLayout.Override.AllowRowLayoutLabelSizing=(RowLayoutSizing.None);
			this.ultraGridColumnChooser1.DisplayLayout.Override.CellClickAction=(CellClickAction.RowSelect);
			this.ultraGridColumnChooser1.DisplayLayout.Override.CellPadding=(2);
			this.ultraGridColumnChooser1.DisplayLayout.Override.ExpansionIndicator=(ShowExpansionIndicator.Never);
			this.ultraGridColumnChooser1.DisplayLayout.Override.HeaderClickAction=(HeaderClickAction.Select);
			this.ultraGridColumnChooser1.DisplayLayout.Override.RowSelectors=(DefaultableBoolean.False);
			this.ultraGridColumnChooser1.DisplayLayout.Override.RowSizing=(RowSizing.AutoFixed);
			this.ultraGridColumnChooser1.DisplayLayout.Override.SelectTypeCell=(SelectType.None);
			this.ultraGridColumnChooser1.DisplayLayout.Override.SelectTypeCol=(SelectType.None);
			this.ultraGridColumnChooser1.DisplayLayout.Override.SelectTypeRow=(SelectType.None);
			this.ultraGridColumnChooser1.DisplayLayout.RowConnectorStyle=(RowConnectorStyle.None);
			this.ultraGridColumnChooser1.DisplayLayout.ScrollBounds=(0);
			this.ultraGridColumnChooser1.DisplayLayout.ScrollStyle=(ScrollStyle.Immediate);
			this.ultraGridColumnChooser1.Location = new System.Drawing.Point(7, 16);
			this.ultraGridColumnChooser1.MultipleBandSupport=(MultipleBandSupport.SingleBandOnly);
			this.ultraGridColumnChooser1.Name = "ultraGridColumnChooser1";
			this.ultraGridColumnChooser1.Size = new Size(170, 212);
			this.ultraGridColumnChooser1.Style=(ColumnChooserStyle.AllColumnsWithCheckBoxes);
