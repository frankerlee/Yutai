...
namespace Yutai.Catalog
{
	public class MyGxFilterRasterDatasets : IGxObjectFilter
	{
		...
		public MyGxFilterRasterDatasets()
		{
		}
		...
		public bool CanChooseObject(IGxObject igxObject_0, ref MyDoubleClickResult myDoubleClickResult_0)
		{
			...
			if (igxObject_0 is IGxDataset)
			{
				...
				else if (type == esriDatasetType.esriDTRasterDataset)
				{
					...
					if (dataset != null)
					{
						if ((dataset as IRasterBandCollection).Count != 1)
						{
							myDoubleClickResult_0 = MyDoubleClickResult.myDCRShowChildren;
						}
						else
		...
		public bool CanDisplayObject(IGxObject igxObject_0)
		{
			...
			{
				if (((igxObject_0 as IGxDataset).Type == esriDatasetType.esriDTRasterBand || (igxObject_0 as IGxDataset).Type == esriDatasetType.esriDTRasterDataset ? false : (igxObject_0 as IGxDataset).Type != esriDatasetType.esriDTRasterBand))
				{
					flag = false;
					return flag;
				}
