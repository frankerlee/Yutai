...
namespace Yutai.Catalog
{
	public class MyGxFilterTablesAndFeatureClasses : IGxObjectFilter
	{
		...
		public MyGxFilterTablesAndFeatureClasses()
		{
		}
		...
		public bool CanChooseObject(IGxObject igxObject_0, ref MyDoubleClickResult myDoubleClickResult_0)
		{
			...
			{
				if (((igxObject_0 as IGxDataset).DatasetName.Type == esriDatasetType.esriDTTable ? true : (igxObject_0 as IGxDataset).DatasetName.Type == esriDatasetType.esriDTFeatureClass))
				{
		...
		public bool CanDisplayObject(IGxObject igxObject_0)
		{
			...
			{
				if (((igxObject_0 as IGxDataset).DatasetName.Type == esriDatasetType.esriDTTable || (igxObject_0 as IGxDataset).DatasetName.Type == esriDatasetType.esriDTFeatureClass ? false : (igxObject_0 as IGxDataset).DatasetName.Type != esriDatasetType.esriDTFeatureDataset))
				{
					flag = false;
					return flag;
				}
