...
namespace Yutai.Catalog.UI
{
    ...
    public class KTreeView : TreeView
    {
        ...
        private IPropertySet ipropertySet_0 = new PropertySet();
        ...
        public event SelectNodeChangedHandler  selectNodeChangedHandler_0;
        ...
        public void InitTreeView()
        {
            ...
            {
                this.GxCatalog = new Yutai.Catalog.GxCatalog();
            }
            base.Nodes.Clear();
        ...
        private void KTreeView_DragDrop(object sender, DragEventArgs e)
        {
            if (this.bool_0)
            {
                ...
                if (tag is IGxObjectContainer)
                {
                    ...
                    IEnumNameEdit edit = new NamesEnumerator() as IEnumNameEdit;
