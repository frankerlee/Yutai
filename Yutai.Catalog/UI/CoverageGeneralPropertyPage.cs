namespace Yutai.Catalog.UI
{
    ...
    public class CoverageGeneralPropertyPage : UserControl
    {
        ...
        private Button txtFeatureCount;
        private Button txtName;
        private Button txtPercise;
        ...
        private void InitializeComponent()
        {
            ...
            this.txtPercise = new Button();
            this.listView1 = new ListView();
            this.columnHeader_0 = new ColumnHeader();
            this.columnHeader_1 = new ColumnHeader();
            this.columnHeader_2 = new ColumnHeader();
            this.label4 = new Label();
            this.txtFeatureCount = new Button();
            this.btnBulid = new Button();
