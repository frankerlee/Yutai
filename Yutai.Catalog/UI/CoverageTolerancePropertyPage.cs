namespace Yutai.Catalog.UI
{
    ...
    public class CoverageTolerancePropertyPage : UserControl
    {
        ...
        private Button textDangle;
        private Button txtEdit;
        private Button txtFuzzy;
        private Button txtGrain;
        private Button txtNodeSnap;
        private Button txtSnap;
        private Button txtTicMatch;
        private Button txtWeed;
        ...
        private void InitializeComponent()
        {
            ...
            this.txtFuzzy = new Button();
            this.textDangle = new Button();
            this.txtGrain = new Button();
            this.txtEdit = new Button();
            this.label3 = new Label();
            this.label4 = new Label();
            this.txtSnap = new Button();
            this.txtNodeSnap = new Button();
            this.label5 = new Label();
            this.label6 = new Label();
            this.txtWeed = new Button();
            this.txtTicMatch = new Button();
