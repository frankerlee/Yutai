namespace Yutai.Catalog.UI
{
    ...
    internal class ServerObjectProcessManagementPropertyPage : UserControl
    {
        ...
        private ComboBox cboIsolationLevel;
        ...
        private TextBox timeEdit1;
        private Button txtRecycleInterval;
        ...
        private void InitializeComponent()
        {
            ...
            this.txtRecycleInterval = new Button();
            this.timeEdit1 = new TextBox();
            this.cboIsolationLevel = new ComboBox();
            ...
            this.label5.Text = "小时";
            this.txtRecycleInterval.Text = "10";
            ...
            this.txtRecycleInterval.TextChanged += new EventHandler(this.txtRecycleInterval_EditValueChanged);
            this.timeEdit1.Text = new DateTime(0x7d6, 1, 0x1b, 0x17, 5, 0, 0).ToString();
            this.timeEdit1.Location = new Point(0x88, 0x98);
            this.timeEdit1.Name = "timeEdit1";
       
            this.timeEdit1.Size = new Size(120, 0x17);
            this.timeEdit1.TabIndex = 7;
            this.timeEdit1.TextChanged += new EventHandler(this.timeEdit1_EditValueChanged);
            this.cboIsolationLevel.Text = "每一个实例一个进程(高孤立性)";
            this.cboIsolationLevel.Location = new Point(0x10, 0x20);
            this.cboIsolationLevel.Name = "cboIsolationLevel";
            
            this.cboIsolationLevel.Items.AddRange(new object[] { "每一个实例一个进程(高孤立性)", "仅一个进程(低孤立性)" });
        ...
        private void method_0()
        {
            ...
            if (this.string_0 == "Stoped")
            {
                ...
                this.txtRecycleInterval.Enabled = false;
                this.timeEdit1.Enabled = false;
            }
            else
            {
                this.cboIsolationLevel.Enabled = true;
                this.txtRecycleInterval.Enabled = true;
