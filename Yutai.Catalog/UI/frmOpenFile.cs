...
namespace Yutai.Catalog.UI
{
    ...
    public class frmOpenFile : Form
    {
        ...
        private CatalogComboBox imageComboBox1;
        ...
        {
            CatalogComboItem ex = this.imageComboBox1.SelectedItem;
            
            if (ex.Level != 0)
            {
                if (ex.Level == 1)
                {
                    this.imageComboBox1.SelectedIndex = 0;
                }
                else
                {
                    int num = this.imageComboBox1.SelectedIndex - 1;
                    this.imageComboBox1.SelectedIndex = num;
                }
            }
        }
        ...
        private void cboShowType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            this.method_8();
            CatalogComboItem ex = this.imageComboBox1.SelectedItem as CatalogComboItem;
        ...
        private void frmOpenFile_Load(object sender, EventArgs e)
        {
            ...
            {
                this.igxCatalog_0 = new Yutai.Catalog.GxCatalog();
            }
            CatalogComboItem item = new CatalogComboItem((igxCatalog_0 as IGxObject).Name, (igxCatalog_0 as IGxObject).FullName, this.method_2(this.igxCatalog_0 as IGxObject), 0) {
                Tag = this.igxCatalog_0
            };
            this.imageComboBox1.Items.Add(item);
            ...
            {
                item = new CatalogComboItem(obj3.Name, obj3.FullName, this.method_2(obj3), 1) {
                    Tag = obj3
                };
                this.imageComboBox1.Items.Add(item);
            }
        ...
        private void imageComboBox1_SelectedIndexChanged(CatalogComboItem item)
        {
            if (item!=null)
            {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnUpper = new Button();
            this.imageComboBox1 = new CatalogComboBox();
            this.cboShowType = new ComboBox();
            this.btnLargeIcon = new Button();
            this.btnList = new Button();
            this.btnDetial = new Button();
            ...
            this.imageComboBox1.Location = new System.Drawing.Point(0x38, 8);
            this.imageComboBox1.Name = "imageComboBox1";
           
            this.imageComboBox1.Size = new Size(0x128, 0x15);
            this.imageComboBox1.TabIndex = 11;
            //this.imageComboBox1.SelectedItemChanged += new EventHandler(this.imageComboBox1_SelectedIndexChanged);
            this.cboShowType.Text="";
            ...
            base.Controls.Add(this.imageComboBox1);
        ...
        private void listView1_DoubleClick(object sender, EventArgs e)
        {
            if (this.listView1.SelectedItems.Count != 0)
            {
                    ...
                    if (tag is IGxNewDatabase)
                    {
                        ...
                        if (tag.FullName == "添加OLE DB连接")
                        {
                            try
                            {
                                ...
                                if (Directory.Exists(path))
                                {
                                    ...
                                    IWorkspaceFactory factory = new OLEDBWorkspaceFactory();
                        ...
                        else if (tag.FullName == "添加空间数据库连接")
                        {
                            ...
                            if (connection.ShowDialog() == DialogResult.OK)
                            {
                                ...
                                name.PathName = connection.ConnectionPath;
                ...
                else
                {
                    ...
                    {
                        for (int i = 0; i < this.imageComboBox1.Items.Count; i++)
                        {
                            ex = this.imageComboBox1.Items[i] as CatalogComboItem;
                            if (ex.Tag == tag)
                            {
                                this.imageComboBox1.SelectedIndex = i;
                                break;
                            }
                        }
                    }
                    ...
                    {
                        ex = this.imageComboBox1.Items[this.imageComboBox1.SelectedIndex] as CatalogComboItem;
                        int degree = ex.Level;
                        ex = new CatalogComboItem(tag.Name, tag.FullName, this.method_2(tag), degree + 1) {
                            Tag = tag
                        };
                        int selectedIndex = this.imageComboBox1.SelectedIndex;
                        this.imageComboBox1.Items.Insert(selectedIndex + 1, ex);
                        this.imageComboBox1.SelectedIndex = selectedIndex + 1;
                    }
                    this.bool_0 = true;
                }
            }
        ...
        {
            CatalogComboItem ex = this.imageComboBox1.Items[this.imageComboBox1.SelectedIndex] as CatalogComboItem;
            IGxObject tag = ex.Tag as IGxObject;
            for (int i = this.imageComboBox1.Items.Count - 1; i > 0; i--)
            {
                ex = this.imageComboBox1.Items[i] as CatalogComboItem;
                IGxObject obj3 = ex.Tag as IGxObject;
                if ((!(obj3 is IGxCatalog) && !(obj3.Parent is IGxCatalog)) && ((obj3 != tag) && !this.method_11(obj3, tag)))
                {
                    this.imageComboBox1.Items.RemoveAt(i);
                }
            }
        }
        ...
        private void method_18()
        {
            ...
            {
                CatalogComboItem selectedItem = this.imageComboBox1.SelectedItem as CatalogComboItem;
        ...
        private bool method_5(IGxObject igxObject_1)
        {
            ...
            {
                for (int j = 0; j < this.imageComboBox1.Items.Count; j++)
                {
                    ex = this.imageComboBox1.Items[j] as CatalogComboItem;
                    if (ex.Tag == igxObject_1)
                    {
                        this.imageComboBox1.SelectedIndex = j;
                        break;
                    }
                }
            }
            else
            {
                ex = this.imageComboBox1.Items[this.imageComboBox1.SelectedIndex] as CatalogComboItem;
                int degree = ex.Level;
                ex = new CatalogComboItem(igxObject_1.Name, igxObject_1.FullName, this.method_2(igxObject_1), degree + 1) {
                    Tag = igxObject_1
                };
                this.imageComboBox1.Items.Insert(this.imageComboBox1.SelectedIndex + 1, ex);
                this.imageComboBox1.SelectedIndex++;
            }
            this.bool_0 = true;
            return true;
        }
