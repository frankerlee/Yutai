...
namespace Yutai.Catalog
{
	public class MyGxFilterFileGeodatabases : IGxObjectFilter
	{
		...
		public MyGxFilterFileGeodatabases()
		{
		}
		...
		public bool CanDisplayObject(IGxObject igxObject_0)
		{
			...
			if ((igxObject_0 is IGxDiskConnection ? false : !(igxObject_0 is IGxFolder)))
			{
				flag = (!(igxObject_0 is IGxDatabase) || (igxObject_0 as IGxDatabase).IsRemoteDatabase || !(Path.GetExtension(igxObject_0.Name).ToLower() == ".gdb") ? false : true);
			}
			else
			{
				flag = true;
