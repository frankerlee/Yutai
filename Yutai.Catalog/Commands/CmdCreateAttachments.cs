...
{
    class CmdCreateAttachments : YutaiCommand
    {

        public CmdCreateAttachments(IAppContext context)
        {
            OnCreate(context);
        }
        ...
        public override void OnCreate(object hook)
        {
            ...
            this.m_message = "创建附件";
            this.m_name = "Catalog_CreateAttachments";
            this._key = "Catalog_CreateAttachments";
            this.m_toolTip = "创建附件";
