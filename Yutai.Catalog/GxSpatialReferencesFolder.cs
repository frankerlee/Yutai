...
{
	public class GxSpatialReferencesFolder : IGxObject, IGxObjectContainer, IGxObjectEdit, IGxObjectProperties, IGxObjectUI, IGxPasteTarget, IGxSpatialReferencesFolder
	{
		...
		public GxSpatialReferencesFolder()
		{
		}
