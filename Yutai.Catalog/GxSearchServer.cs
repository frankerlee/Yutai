...
{
	public class GxSearchServer : IGxObject, IGxObjectEdit, IGxObjectProperties, IGxObjectUI, IGxContextMenuWap, IGxAGSObject, IGxLayerSource
	{
		private int int_0 = -1;
		...
		public string Category
		{
			...
			{
				string str;
				str = (this.iagsserverObjectName_0 == null ? "SearchServer" : this.iagsserverObjectName_0.Type);
				return str;
			}
		}
		...
		public Bitmap LargeImage
		{
			get
			{
				...
				{
					smallImage = ImageLib.GetSmallImage(86);
				}
				else if (this.Status != "Stopped")
				{
					smallImage = (this.Status != "Paused" ? ImageLib.GetSmallImage(86) : ImageLib.GetSmallImage(88));
				}
				else
				{
					smallImage = ImageLib.GetSmallImage(87);
				}
				return smallImage;
			}
		}
		...
		public Bitmap SmallImage
		{
			get
			{
				...
				if (this.Status == "Started")
				{
					smallImage = ImageLib.GetSmallImage(80);
				}
				else if (this.Status != "Stopped")
				{
					smallImage = (this.Status != "Paused" ? ImageLib.GetSmallImage(80) : ImageLib.GetSmallImage(82));
				}
				else
				{
					smallImage = ImageLib.GetSmallImage(81);
				}
				return smallImage;
			}
		}
