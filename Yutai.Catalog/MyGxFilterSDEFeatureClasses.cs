...
{
	public class MyGxFilterSDEFeatureClasses : IGxObjectFilter
	{
		...
		public MyGxFilterSDEFeatureClasses()
		{
		}
		...
		public bool CanDisplayObject(IGxObject igxObject_0)
		{
			...
			if ((igxObject_0 is IGxDiskConnection ? false : !(igxObject_0 is IGxFolder)))
			{
				...
				else if (igxObject_0 is IGxRemoteDatabaseFolder)
				{
					flag = true;
					return flag;
				}
				else if (!(igxObject_0 is IGxNewDatabase))
				{
					if (!(igxObject_0 is IGxDataset))
					{
						goto Label1;
