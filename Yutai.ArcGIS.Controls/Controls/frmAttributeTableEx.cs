...
{
    public class frmAttributeTableEx : Form
    {
        ...
        private void AddRecordToListView(bool bAll)
        {
            try
            {
                ...
                {
                    num = ((this.m_RecordNum - this.m_pDataTable.Rows.Count) > 0x3e8) ? 0x3e8 : this.m_RecordNum;
                }
                ...
                if (pTable.FeatureClass != null)
                {
                    ...
                    if (row is DataRowView)
                    {
                        try
                        {
                            ...
                            if (this.m_pMap is IMap)
                            {
                                Common.Zoom2Feature(this.m_pMap as IActiveView, feature);
                            }
                            else if (this.m_pMap is IScene)
                            {
                            }
        ...
        private void InitializeComponent()
        {
            ...
            this.dataGrid1.Size = new Size(0x266, 230);
            ...
            this.gridView1.Appearance.SelectedRow.BackColor = Color.FromArgb(0xb0, 0xff, 0xff);
            this.gridView1.Appearance.SelectedRow.BackColor2 = Color.FromArgb(0xb0, 0xff, 0xff);
            ...
            this.panel1.Size = new Size(0x266, 0x20);
            ...
            base.ClientSize = new Size(0x266, 0x106);
