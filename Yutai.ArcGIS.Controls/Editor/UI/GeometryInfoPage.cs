...
{
    public class GeometryInfoPage : UserControl, IDockContent
    {
        private Bar bar1;
        private Bar bar2;
        ...
        private void InitializeComponent()
        {
            ...
            this.bar1 = new Bar();
            this.BarGeometryInfo = new BarStaticItem();
            this.bar2 = new Bar();
            this.ImportGeometryData = new BarButtonItem();
            ...
            this.InsertPointBefore = new BarButtonItem();
            this.InsertPointAfter = new BarButtonItem();
            this.DeletePoints = new BarButtonItem();
            this.popupMenu1 = new PopupMenu();
            this.ExportGeometry = new BarButtonItem();
            ...
            this.listBox1.Size = new Size(0x68, 0xf4);
            ...
            this.listView1.Location = new System.Drawing.Point(0x68, 0);
            this.listView1.LockRowCount = 0;
            this.listView1.MultiSelect = false;
            this.listView1.Name = "listView1";
            this.listView1.Size = new Size(0xa2, 0xfc);
            this.listView1.TabIndex = 2;
            this.listView1.View = View.Details;
            this.listView1.ValueChanged += new ValueChangedHandler(this.listView1_ValueChanged);
            ...
            this.barManager1.Items.AddRange(new BarItem[] { this.InsertPointBefore, this.InsertPointAfter, this.DeletePoints, this.BarGeometryInfo, this.ImportGeometryData, this.ExportGeometry });
            ...
            this.bar1.LinksPersistInfo.AddRange(new LinkPersistInfo[] { new LinkPersistInfo(this.BarGeometryInfo) });
            this.bar1.OptionsBar.AllowQuickCustomization = false;
            this.bar1.OptionsBar.DrawDragBorder = false;
            this.bar1.OptionsBar.RotateWhenVertical = false;
            this.bar1.OptionsBar.UseWholeRow = true;
            this.bar1.Text = "状态栏";
            this.BarGeometryInfo.AutoSize = BarStaticItemSize.Spring;
            this.BarGeometryInfo.Id = 3;
            this.BarGeometryInfo.Name = "BarGeometryInfo";
            this.BarGeometryInfo.TextAlignment = StringAlignment.Near;
            this.BarGeometryInfo.Width = 0x20;
            this.bar2.BarName = "工具";
            this.bar2.CanDockStyle = BarCanDockStyle.Right;
            this.bar2.DockCol = 0;
            this.bar2.DockRow = 0;
            this.bar2.DockStyle = BarDockStyle.Right;
            this.bar2.LinksPersistInfo.AddRange(new LinkPersistInfo[] { new LinkPersistInfo(this.ImportGeometryData), new LinkPersistInfo(this.ExportGeometry, true) });
            ...
            this.ImportGeometryData.ItemClick += new ItemClickEventHandler(this.ImportGeometryData_ItemClick);
            this.InsertPointBefore.Caption = "在之前插入点";
            this.InsertPointBefore.Id = 0;
            this.InsertPointBefore.Name = "InsertPointBefore";
            this.InsertPointBefore.ItemClick += new ItemClickEventHandler(this.InsertPointBefore_ItemClick);
            this.InsertPointAfter.Caption = "在之后插入点";
            this.InsertPointAfter.Id = 1;
            this.InsertPointAfter.Name = "InsertPointAfter";
            this.InsertPointAfter.ItemClick += new ItemClickEventHandler(this.InsertPointAfter_ItemClick);
            this.DeletePoints.Caption = "删除";
            this.DeletePoints.Id = 2;
            this.DeletePoints.Name = "DeletePoints";
            this.DeletePoints.ItemClick += new ItemClickEventHandler(this.DeletePoints_ItemClick);
            this.popupMenu1.LinksPersistInfo.AddRange(new LinkPersistInfo[] { new LinkPersistInfo(this.InsertPointBefore), new LinkPersistInfo(this.InsertPointAfter), new LinkPersistInfo(this.DeletePoints, true) });
            this.popupMenu1.Manager = this.barManager1;
            this.popupMenu1.Name = "popupMenu1";
            this.ExportGeometry.Caption = "导出几何数据";
            this.ExportGeometry.Id = 5;
            this.ExportGeometry.Name = "ExportGeometry";
            this.ExportGeometry.ItemClick += new ItemClickEventHandler(this.ExportGeometry_ItemClick);
            ...
            base.Name = "GeometryInfoPage";
            base.Size = new Size(0x124, 270);
            base.Load += new EventHandler(this.frmGeometryInfo_Load);
