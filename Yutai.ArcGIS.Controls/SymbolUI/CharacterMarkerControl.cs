...
namespace Yutai.ArcGIS.Controls.SymbolUI
{
    internal class CharacterMarkerControl : UserControl, CommonInterface
    {
        ...
        private void InitializeComponent()
        {
            ...
            bits = new int[4];
            bits[0] = 100;
            this.numUpDownXOffset.Properties.MaxValue = new decimal(bits);
            bits = new int[4];
            bits[0] = 100;
            bits[3] = -2147483648;
            this.numUpDownXOffset.Properties.MinValue = new decimal(bits);
            ...
            bits = new int[4];
            this.numUpDownYOffset.EditValue = new decimal(bits);
            ...
            bits = new int[4];
            bits[0] = 100;
            this.numUpDownYOffset.Properties.MaxValue = new decimal(bits);
            bits = new int[4];
            bits[0] = 100;
            bits[3] = -2147483648;
            this.numUpDownYOffset.Properties.MinValue = new decimal(bits);
            ...
            bits = new int[4];
            this.numUpDownAngle.EditValue = new decimal(bits);
            ...
            bits = new int[4];
            bits[0] = 360;
            this.numUpDownAngle.Properties.MaxValue = new decimal(bits);
            bits = new int[4];
            bits[0] = 360;
            bits[3] = -2147483648;
            this.numUpDownAngle.Properties.MinValue = new decimal(bits);
