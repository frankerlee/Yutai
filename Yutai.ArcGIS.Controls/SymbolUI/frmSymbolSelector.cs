    ...
    public class frmSymbolSelector : Form
    {
        ...
        private void AddSymbol(string FileName)
        {
            ...
            switch (this.m_SymbolType)
            {
                ...
                case enumSymbolType.enumSTRepresentationMarker:
                    item = this.m_pSG.get_Items(this.m_ClassName, FileName, this.m_Category);
                    break;

                case enumSymbolType.enumSTRepresentationRuleItem:
                    item = this.m_pSG.get_Items(this.m_ClassName, FileName, this.m_Category);
                    break;
            }
            if (item != null)
            {
                ...
                {
                    this.symbolListView1.Add(item2, FileName);
                }
                item.Reset();
                item = null;
                GC.Collect();
        ...
        private void frmSymbolSelector_Load(object sender, EventArgs e)
        {
            ...
            switch (this.m_SymbolType)
            {
                ...
                case enumSymbolType.enumSTRepresentationMarker:
                    this.m_ClassName = "Representation Markers";
                    this.ReadCategories("Representation Markers");
                    this.symbolListView1.SetItemSize(20, 20, 50, 50);
                    break;

                case enumSymbolType.enumSTRepresentationRuleItem:
                    this.m_ClassName = "Representation Rules";
                    this.ReadCategories("Representation Rules");
                    this.symbolListView1.SetItemSize(20, 20, 50, 50);
                    break;
            }
            if (this.m_pSG != null)
        ...
        public object GetSymbol()
        {
            if (this.m_pSG != null)
            {
                try
                {
                    string selectItemStyleFileName = this.symbolListView1.GetSelectItemStyleFileName();
                    if (selectItemStyleFileName != "")
                    {
                        (this.m_pSG as IStyleGalleryStorage).TargetFile = selectItemStyleFileName;
                    }
                }
                catch (Exception)
                {
            ...
            try
            {
                if (pSymbol != null)
                {
                    ...
                    else if (pSymbol is ILineSymbol)
                    {
                        ...
                        decimal width = (decimal) ((ILineSymbol) pSymbol).Width;
                        this.spinEditWidth.Value = width;
                    ...
                    {
                        this.colorEditFill.Enabled = true;
                        this.groupBoxFill.Visible = true;
        ...
        private void InitializeComponent()
        {
            ...
            this.groupBox1.Location = new Point(310, 0x10);
            ...
            this.symbolListView1.Size = new Size(0x12f, 0x170);
            ...
            this.groupBoxFill.Location = new Point(310, 0x90);
            ...
            this.groupBoxLine.Location = new Point(0x137, 0x90);
            ...
            this.groupBoxMarker.Location = new Point(310, 0x90);
        ...
        public void SetSymbol(object pSym)
        {
            if (pSym != null)
            {
                ...
                if (pSym is IStyleGalleryItem)
                {
                    pSym = (pSym as IStyleGalleryItem).Item;
                }
                this.symbolItem1.Symbol = this.m_pPreviewSelSymbol;
                if (pSym == null)
                {
                ...
                else if (pSym is IRepresentationMarker)
                {
                    this.m_SymbolType = enumSymbolType.enumSTRepresentationMarker;
                }
                else if (pSym is IRepresentationRuleItem)
                {
                    this.m_SymbolType = enumSymbolType.enumSTRepresentationRuleItem;
                }
            }
        }
        ...
        public IStyleGalleryItem SelectedStyleGalleryItem
        {
            get
            {
                if (this.m_pSG != null)
                {
                    (this.m_pSG as IStyleGalleryStorage).TargetFile = this.symbolListView1.GetSelectItemStyleFileName();
                }
                return this.symbolListView1.GetSelectStyleGalleryItem();
            }
        }
