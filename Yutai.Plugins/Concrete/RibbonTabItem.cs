...
namespace Yutai.Plugins.Concrete
{
    ...
    {
        public RibbonTabItem(string category, string key, string name, string caption, string tooltip)
            : base(category, key, name, caption, tooltip)
        {
        }
        ...
        public RibbonTabItem(Bitmap bitmap, string caption, string category, int helpContextId, string helpFile,
            string message, string name, string toolTip)
